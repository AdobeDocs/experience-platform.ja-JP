...
このドキュメントでは、監視ダッシュボードを使用して、取り込みと保持の両方を含む、データレイクのすべてのデータ処理を監視する方法について説明します。
...
監視ダッシュボードのメインヘッダーから「**[!UICONTROL Data lake]**」を選択して、データレイクの取り込み率を表示します。
...
| マイソース | [!UICONTROL My sources] ドロップダウンメニューを使用して、ビューをさらにフィルタリングできます。 ドロップダウンメニューを使用すると、カテゴリでビューをフィルタリングできます。 または、「**[!UICONTROL All sources]**」を選択してすべてのソースまたはソースの指標を表示するか、「**[!UICONTROL My sources]**」を選択して、対応するアカウントを持つソースのみを表示することもできます。 |
