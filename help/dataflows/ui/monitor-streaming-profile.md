...
>title="ストリーミングプロファイルの取り込みを監視"
>abstract="ストリーミングプロファイルのモニタリングダッシュボードには、スループットと取り込み率に関する情報が表示されます。このダッシュボードを使用して、。Experience Platform へのストリーミングプロファイルのデータ処理指標を表示、理解、分析します。"
...
>title="最大スループット"
>abstract="この指標は、ストリーミングプロファイル取り込みにエントリするインバウンドリクエストの、1 秒あたりの最大数を表します。"
>text="Learn more in documentation"
