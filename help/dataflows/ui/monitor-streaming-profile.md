...
[!UICONTROL &#x200B; モニタリング &#x200B;] ダッシュボードには、取り込みおよび処理のためのリアルタイム指標が表示されます。 これらの数値は、アクティビティ時に記録された正確な指標です。 逆に、[!UICONTROL &#x200B; 処理能力 &#x200B;] ダッシュボードでは、スループット処理能力の計算にスムージングのメカニズムを使用します。 このメカニズムは、違反として即座に認定することで、短期間のスパイクを減らすのに役立ち、容量アラートが一時的なバーストではなく、持続的なトレンドに焦点を当てることを保証します。

スムージングのメカニズムにより、次の問題が発生することがあります。

* [!UICONTROL &#x200B; 容量 &#x200B;] に表示されない [!UICONTROL &#x200B; 監視 &#x200B;] の小さなスパイク。
* 同じタイムスタンプの [!UICONTROL &#x200B; 監視 &#x200B;] と比較して、[!UICONTROL &#x200B; 処理能力 &#x200B;] の値が若干低くなります。

2 つのダッシュボードは正確ですが、目的が異なるように設計されています。

* [!UICONTROL &#x200B; モニタリング &#x200B;]：詳細なリアルタイムのオペレーショナル可視性。
* [!UICONTROL &#x200B; 処理能力 &#x200B;]：使用状況と違反パターンを特定する戦略ビュー
