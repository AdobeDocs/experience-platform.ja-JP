...
**ExperienceEvent:** ExperienceEventは、関連する対象のポイントインタイムやIDなど、観測データをキャプチャするエクスペリエンスプラットフォームの標準スキーマです。 エクスペリエンスイベントは、発生した事実の記録で、集計や解釈なしで発生したことを表します。
...
**取り込み：** インジェストは、ソースからエクスペリエンスプラットフォームにデータを追加するプロセスです。 データは、ストリーム化、バッチ化、コネクタ経由での追加など、様々な方法でエクスペリエンスプラットフォームに取り込むことができます。
