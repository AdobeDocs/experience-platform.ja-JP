...
**アクセスキー ID**:アクセスキー ID は、 [!DNL Amazon] S3 秘密アクセスキーに関連付けられた一意の識別子です。アクセスキー ID と秘密アクセスキーは、[!DNL Amazon Web Services](AWS) 要求への署名に使用されます。
...
**[!DNL Intelligent Services]**: [!DNL Intelligent Services] やな [!DNL Attribution AI] ど [!DNL Customer AI] は、機械学習を通じた人工知能ベースのモデルで、Experience Platform( またはReal-time Customer Data Platformなどの Platform 上に構築されたアプリケーション ) を実行して操作する必要があります。
...
**秘密鍵**:秘密アクセスキーは、 [!DNL Amazon] AWS要求に署名するためにアクセスキー ID と組み合わせて使用される S3 キーです。
