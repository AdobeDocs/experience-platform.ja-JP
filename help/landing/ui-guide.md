...
Offer Decisioning は、Adobe Experience Platform と統合されたアプリケーションサービスです。Experience Platformを使用すると、すべてのタッチポイントにわたって適切なタイミングで顧客に最適なオファーとエクスペリエンスを提供できます。 の使用を含むOffer decisioningの詳細については、 [!UICONTROL オファー] および [!UICONTROL アクティビティ] を [offer decisioning文書](https://experienceleague.adobe.com/docs/offer-decisioning.html?lang=ja).
