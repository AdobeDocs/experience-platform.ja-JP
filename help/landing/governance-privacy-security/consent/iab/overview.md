...
## TCFの同意フィールドを使用したデータセットの作成 {#datasets}
...
## Experience PlatformWeb SDKを統合して、顧客の同意データを収集する {#sdk}
...
SDKがExperience Platformにデータを送信するには、まず[!DNL Adobe Experience Platform Launch]にPlatform用の新しいエッジ設定を作成する必要があります。 新しい設定を作成する方法に関する具体的な手順は、[SDKドキュメント](../../../../edge/fundamentals/datastreams.md)に記載されています。
