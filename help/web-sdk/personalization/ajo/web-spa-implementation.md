...
1. インストール [Adobe Experience Platform Web SDK](/help/web-sdk/install/overview.md) そして、 [web チャネルの前提条件](https://experienceleague.adobe.com/docs/journey-optimizer/using/web/configure-web-channel/web-prerequisites.html) ページに貼り付けます。
