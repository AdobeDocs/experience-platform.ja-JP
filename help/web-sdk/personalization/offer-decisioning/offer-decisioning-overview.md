...
* **データストリーム：** 詳しくは、 [datastreams](/help/datastreams/overview.md) ドキュメント。
...
1. でAdobe Experience Platformを有効にした [datastream](/help/datastreams/overview.md) 「Offer decisioning」ボックスをオンにします。

   ![offer-decisioning-edge-config](./assets/offer-decisioning-edge-config.png)

1. 手順に従って、 [SDK のインストール](/help/web-sdk/install/overview.md) (SDK は、スタンドアロンでインストールすることも、UI を通じてインストールすることもできます。 詳しくは、 [タグクイックスタートガイド](/help/tags/quick-start/quick-start.md)) を参照してください。
1. 次を使用して SDK をOffer decisioning用に設定 `personalization.decisionScopes`. その他のOffer decisioning固有の手順を以下に示します。

   * スタンドアロン SDK のインストール

      1. を使用した「sendEvent」アクションの設定 `personalization.decisionScopes`
   ...
   * タグを使用した SDK のインストール
      ...
      1. を作成します。 [ルール](/help/tags/ui/managing-resources/rules.md).

         * Platform Web SDK の「イベントの送信」アクションを追加し、関連する `decisionScopes` アクションの設定に対して

         ![send-event-action-decisionScopes](./assets/send-event-action-decisionScopes.png)

      1. [ライブラリの作成と公開](/help/tags/ui/publishing/libraries.md) には、設定したすべての関連するルール、データ要素、拡張機能が含まれています。
