...
CSP の設定について詳しくは、 [専用ドキュメント](../use-cases/configuring-a-csp.md).
...
Adobe Analytics の [Web SDK の設定](../commands/configure/overview.md) を設定します。 `personalizationStorageEnabled` オプションを選択します。
