...
[!DNL Observability Insights] API は、様々なAdobe Experience Platform機能の指標データをプログラムで取得および監視できるエンドポイントを提供します。 このエンドポイントの概要を以下に示します。 詳しくは、エンドポイントガイドを参照し、必要なヘッダー、サンプル API 呼び出しの読み方などの重要な情報については、[ はじめにのガイド ](./getting-started.md) を参照してください。
...
観察性指標は、Adobe Experience Platformの様々な機能の使用状況統計、過去の傾向、パフォーマンス指標に関するインサイトを提供します。 API を使用して指標を取得する方法については、[ 指標エンドポイントガイド ](./metrics.md) を参照してください。
