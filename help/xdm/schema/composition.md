...
一般に「ID」とマークされるフィールドには、次のものが含まれます。電子メールアドレス、電話番号、 [Experience Cloud ID(ECID)](https://marketing.adobe.com/resources/help/en_US/mcvid/)、CRM IDまたはその他の一意のIDフィールド。 また、「ID」フィールドとしても適切な場合があるので、組織に固有の一意の識別子も考慮する必要があります。
