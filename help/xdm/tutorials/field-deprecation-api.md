...
このドキュメントでは、様々な XDM リソースのフィールドを非推奨にする方法について説明します。 Experience Platformユーザーインターフェイスのスキーマエディターを使用した XDM フィールドの廃止手順については、 [UI での XDM フィールドの廃止](./field-deprecation-ui.md).
