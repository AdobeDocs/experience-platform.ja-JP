...
一般に「ID」とマークされるフィールドには、次のものが含まれます。電子メールアドレス、電話番号、 [Experience Cloud ID(ECID)](https://marketing.adobe.com/resources/help/en_US/mcvid/)、CRM IDまたはその他の一意のIDフィールド。
...
和集合表示の使用に関する詳細は、『スキーマレジストリ開発者ガイド』の [和集合](../api/unions.md) の節を参照してください。
