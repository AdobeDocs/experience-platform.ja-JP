...
title: サブスクリプションデータタイプ
description: Subscription Experience Data Model(XDM) データタイプについて説明します。
...
| `billingStartDate` | 日付 | 最初の請求書の支払期日。 日付形式（時刻なし）は、 [RFC 3339、セクション 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) 標準。 |
