...
* スキーマ {#schema}
   ...
   * ヘルスケアデータモデル V2 {#healthcare}
      ...
      * フィールドグループ {#field-groups}
         ...
         * [カバー範囲](./schema/healthcare/field-groups/coverage.md)
         ...
         * [調剤剤](./schema/healthcare/field-groups/medication-dispense.md)
         * [投薬申請](./schema/healthcare/field-groups/medication-request.md)
      ...
      * データタイプ {#data-types}
         ...
         * [コード可能なコンセプト](./schema/healthcare/data-types/codeable-concept.md)
         * [コード可能な参照](./schema/healthcare/data-types/codeable-reference.md)
         * [コーディング](./schema/healthcare/data-types/coding.md)
         * [連絡先](./schema/healthcare/data-types/contact-point.md)
         * [投与量](./schema/healthcare/data-types/dosage.md)
         ...
         * [単純な数量](./schema/healthcare/data-types/simple-quantity.md)
...
* フィールドグループ {#field-groups}
   * XDM 個人プロファイル {#profile}
      ...
      * [プロファイルパートナー強化（サンプル）](./field-groups/profile/profile-partner-enrichment.md)
   ...
   * XDM個人見込み客プロファイル {#prospect-profile}
      * [パートナー見込客の詳細（サンプル）](./field-groups/prospect-profile/partner-prospect-details.md)
   ...
   * 医薬品 {#medication}
      * [ヘルスケア薬](./field-groups/medication/healthcare-medication.md)
   * プラン {#plan}
...
* データタイプ {#data-types}
   ...
   * [Advertising Podの詳細レポート](./data-types/advertising-pod-details-reporting.md)
   ...
   * [カテゴリーデータ](./data-types/category-data.md)
   * [章詳細の収集](./data-types/chapter-details-collection.md)
   * [章詳細レポート](./data-types/chapter-details-reporting.md)
   * [Commerce範囲](./data-types/commerce-scope.md)
   ...
   * [エラー詳細の収集](./data-types/error-details-collection.md)
   ...
   * [状態のリスト開始コレクション](./data-types/list-of-states-start-collection.md)
   ...
   * [QoE （Quality of Experience）データ詳細収集](./data-types/qoe-data-details-collection.md)
   ...
   * [返品項目](./data-types/return-item.md)
   * [Return](./data-types/return.md)
   * [検索](./data-types/search.md)
   * [セッション詳細コレクション](./data-types/session-details-collection.md)
   * [セッション詳細レポート](./data-types/session-details-reporting.md)
...
* [!UICONTROL Schemas] UI {#ui}
   ...
   * [マシンラーニングによるスキーマの構築](./ui/ml-assisted-schema-creation.md)
