...
このガイドでは、XDM システムに関する実用的な理解が必要です。 Experience Platform エコシステム内でのXDMの役割の概要については、[XDMの概要](../../home.md)を参照し、XDM スキーマにフィールドグループがどのように貢献しているかについてスキーマ構成[&#128279;](../../schema/composition.md)の基本を参照してください。
...
[!DNL Schema Editor]が再び表示され、新しいフィールドグループが左側のパネルに表示されます。 これは新しいフィールドグループであるため、現在、スキーマにフィールドは提供されないため、キャンバスは変更されません。 フィールドグループ [&#128279;](#add-fields)にフィールドを追加できるようになりました。
