...
>title="標準またはカスタムフィールドグループフィルター"
>abstract="使用可能なフィールドグループのリストは、作成方法に基づいて事前にフィルタリングされています。 ラジオボタンを選択して、「標準」オプションと「カスタム」オプションのどちらかを選択します。 「標準」オプションはAdobeが作成したエンティティを表示し、「カスタム」オプションは組織内で作成したエンティティを表示します。 フィールドグループの作成と編集について詳しくは、ドキュメントを参照してください。"
