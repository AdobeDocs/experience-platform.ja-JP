...
または、「**[!UICONTROL スキーマを作成]**」を選択すると、「[!UICONTROL  スキーマを作成 ]」ワークフローが表示されます。 「[!UICONTROL  スキーマの詳細 ]」セクションで、「**[!UICONTROL その他]**」を選択します。 使用可能なクラスのリストが表示されます。 ここから、新しいクラスのベースとなる既存のクラスを参照およびフィルタリングできます。
