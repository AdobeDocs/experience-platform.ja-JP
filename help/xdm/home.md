...
また、[!DNL Schema Registry API] または Platform UI の [!UICONTROL  スキーマ ] ワークスペースを使用して、組織に固有の新しいスキーマとリソースを作成および管理することもできます。
...
>[!NOTE]
>
>アドホック動作に基づく標準クラスはありません。アドホックスキーマは、それを使用する Platform プロセスによって自動的に生成されますが、[Schema Registry API を使用して手動で作成 ](./tutorials/ad-hoc.md) することもできます。
