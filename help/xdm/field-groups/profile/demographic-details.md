...
description: 「人口統計の詳細スキーマ」フィールドグループについて説明します。
...
| プロパティ | データタイプ | 説明 |
| --- | --- | --- |
| `person.name` | [人物名](../../data-types/person-name.md) | サブフィールドが個人の名前の様々な要素を表すオブジェクト。 |
...
| `person.nationality` | 文字列 | ISO 3166-1Alpha-2 コードを使用して表される、個人とその国との法的関係。 |
| `person.taxId` | 文字列 | 人物の税/会計 ID ( 米国の TIN やスペインのCIF/NIF など )。 |
