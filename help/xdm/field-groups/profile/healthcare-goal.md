...
![ フィールドグループ構造 ](../../images/field-groups/healthcare-goal/goal.png)
...
| [!UICONTROL  コード化可能な概念を開始 ] | `startCodeableConcept` | [[!UICONTROL  コード化可能な概念 ]](../../data-types/healthcare/codeable-concept.md) | その後、目標を説得する必要があるイベント。 |
