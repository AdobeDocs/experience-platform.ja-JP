...
# [!UICONTROL XDM Business Person Components] スキーマフィールドグループ

>[!AVAILABILITY]
>
>このフィールドグループは、Real-Time CDP B2B editionにアクセスできる組織のみが使用できます。

[!UICONTROL XDM Business Person Components] は、[[!DNL XDM Individual Profile]  クラス &#x200B;](../../classes/individual-profile.md) の標準スキーマフィールドグループで、1 人の人物に対する複数のソースレコードと、人物のセグメント化に必要なその他の属性をキャプチャします。
...
| `workEmail` | [[!UICONTROL Email address]](../../data-types/b2b-source.md) | 人物の仕事用電子メール ID。 |
