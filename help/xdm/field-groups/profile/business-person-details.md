...
# [!UICONTROL XDM Business Person Details] スキーマフィールドグループ

>[!AVAILABILITY]
>
>このフィールドグループは、Real-Time CDP B2B editionにアクセスできる組織のみが使用できます。

[!UICONTROL XDM Business Person Details] は、[[!DNL XDM Individual Profile]  クラス &#x200B;](../../classes/individual-profile.md) の標準スキーマフィールドグループで、B2B エンタープライズのコンテキストでの個人に関する情報を取得します。
...
| `b2b.isBlocked` | ブール | 人物がブロックされているかどうかを示します。 |
| `b2b.isConverted` | ブール | リードが変換されているかどうかを示します。 |
| `b2b.isMarketingSuspended` | ブール | その人物のマーケティングが中断されているかどうかを示します。 |
