...
ID の名前空間をどのように指定するかは、ID データの提供方法によって異なります。データ ID データの提供について詳しくは、 [id データの提供](./home.md#supplying-identity-data-to-identity-service) （内） [!DNL Identity Service] の概要。
