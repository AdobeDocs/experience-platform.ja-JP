---
keywords: Experience Platform；ホーム；人気のあるトピック；ラベル ID
...
スキーマレジストリ API を使用してフィールドを ID としてラベル付けする手順については、[ 記述子のエンドポイントガイド ](../../xdm/api/descriptors.md#create) を参照してください。
