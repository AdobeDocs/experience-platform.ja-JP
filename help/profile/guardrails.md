...
| プロファイルレコードあたりの ExperienceEvents の数 | 5,000 | ソフト | **プロファイルレコードあたりの ExperienceEvents の最大数は 5,000 です。** 5000 を超える ExperienceEvents を持つプロファイルは、 **not** セグメント化について検討する必要があります。 |
