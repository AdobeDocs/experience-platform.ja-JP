...
| すべてのサンドボックスにわたるエッジスループット | 1500 RPS | パフォーマンスガードレール | エッジセグメント化では、Adobe Experience Platform Edge Network に入る 1 秒あたり最大 1500 個のインバウンドイベントをサポートします。 Edge のセグメント化では、Adobe Experience Platform Edge Network に入った後にインバウンドイベントを処理するのに最大 350 ミリ秒かかる場合があります。 詳細を表示： [エッジオーディエンス](/help/segmentation/ui/edge-segmentation.md). |
...
| すべてのサンドボックスにわたるストリーミングスループット | 1500 RPS | パフォーマンスガードレール | ストリーミングセグメント化では、1 秒あたり最大 1500 個のインバウンドイベントをサポートします。 ストリーミングセグメント化では、プロファイルがセグメントのメンバーシップの対象として認定されるまでに最大 5 分かかる場合があります。 詳細を表示： [ストリーミングオーディエンス](/help/segmentation/ui/streaming-segmentation.md). |
