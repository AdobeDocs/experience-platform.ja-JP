...
| ガードレイル | 制限 | 制限タイプ | 説明 |
| --- | --- | --- | --- |
| 次元エンティティごとの最大合計サイズ | 1 GB | ソフト | **ディメンションエンティティの推奨合計サイズの最大値は1 GBです。** 大きなディメンションエンティティを取り込むと、システムのパフォーマンスが低下します。 例えば、10 GBの製品カタログをディメンションエンティティとして読み込むことはお勧めしません。 |
