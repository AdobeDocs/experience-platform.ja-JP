...
リアルタイム顧客プロファイルは、 **主要エンティティ**、および様々なサポートエンティティ。 プライマリエンティティは、プロファイルの特性、行動およびセグメントメンバーシップで構成されます。その他のエンティティには次のものがあり、セグメント化エンジンでプロファイルのプライマリエンティティ外部のデータを利用できます。
