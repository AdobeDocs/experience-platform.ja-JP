...
この **[!UICONTROL オーディエンスのメンバーシップ]** 「 」タブには、個々の顧客プロファイルが現在属しているオーディエンスの名前と説明が表示されます。 このリストは、プロファイルがオーディエンスの資格を満たすか、期限が切れるたびに自動的に更新されます。 現在プロファイルが認定されているオーディエンスの合計数が「 」タブの右側に表示されます。
