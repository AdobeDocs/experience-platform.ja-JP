...
![ カードとグラフの表示切り替えがハイライト表示されています。](../images/user-guide/change-browse-view.png)
...
「**[!UICONTROL Details]**」タブには、選択したプロファイルに関する詳細情報が表示されます。また、顧客プロファイルインサイト、AI insight ウィジェット、カスタマイズ可能なウィジェット、自動分類ウィジェットの 4 つのセクションに分かれています。
