...
![「インサイトを読み込めません」エラーが発生する。](../images/account-profiles/unable-to-load.png)

この問題を解決するには、次のような B2B エンティティデータを取り込む必要があります *オポチュニティ担当者* データをサンドボックスに送信します。 48 時間後、データはウィジェットに反映されます。
