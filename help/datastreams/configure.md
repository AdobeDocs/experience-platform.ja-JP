...
| [!UICONTROL Offer Decisioning] | Web SDK実装の [0}Offer Decisioning} を有効にします。](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioning/get-started-decision/starting-offer-decisioning.html?lang=ja) |
