...
詳しくは、[!DNL Analytics]実装ガイドの「[Edge Networkを使用したAdobe Analyticsの実装](https://experienceleague.adobe.com/en/docs/analytics/implementation/aep-edge/overview)」を参照してください。
