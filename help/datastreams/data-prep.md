...
![フィールドが正常にマッピングされ、進行状況が反映された](assets/data-prep/field-mapped.png)
...
![「[!UICONTROL マッピングをインポート]」ボタンが選択されていることを示す画像](assets/data-prep/import-mapping-button.png)

表示されるダイアログで、マッピングルールを読み込むデータストリームを選択します。データストリームを選択したら、「**[!UICONTROL プレビュー]**」を選択します。

![既存のデータストリームが選択されていることを示す画像](assets/data-prep/select-mapping-rules.png)
...
![読み込まれるマッピングルールを示す画像](assets/data-prep/import-mapping-rules.png)
