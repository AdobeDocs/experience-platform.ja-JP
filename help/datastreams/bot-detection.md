...
ボット検出がデータストリームで機能するには、スキーマに&#x200B;**[!UICONTROL Bot Detection Information]** フィールドグループを追加する必要があります。 スキーマにフィールドグループを追加する方法については、[XDM スキーマ &#x200B;](../xdm/ui/resources/schemas.md#add-field-groups)のドキュメントを参照してください。
