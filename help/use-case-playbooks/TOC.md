---
audience: user
user-guide-title: Adobe Experience Platform ユースケースプレイブック
...
# Adobe Experience Platform ユースケースプレイブック {#use-case-playbooks}

* プレイブック {#playbooks}
   * [概要](/help/use-case-playbooks/playbooks/overview.md)
   * [顧客体験のユースケースを活用したビジネス目標の推進](/help/use-case-playbooks/playbooks/business-use-case-framework.md)
   * [ユースケースプレイブックに移動](/help/use-case-playbooks/playbooks/navigate.md)
