...
プレビューウィンドウでは、データフローに読み込む前に、既存のマッピングを調べることができます。 マッピングを検証したら、「**[!UICONTROL 戻る]** を選択してデータフローのリストに戻り、別のマッピングセットを調べるか、「**[!UICONTROL 選択]** を選択して続行できます。
