...
description: このドキュメントでは、Data Prep における様々なデータタイプの処理方法の概要について説明します。
...
>[!TIP]
>
>現在、バッチ取り込みの日付関数は、日付値が次の形式である場合にミリ秒単位で削除されます：`2024-05-05 20:39:00.005` PST。 ミリ秒を保持するには、次の形式を使用します：`2024-05-05 20:39:00.005-0800`
