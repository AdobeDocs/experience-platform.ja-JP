...
リレーショナル、NoSQL、data warehouseなど、サードパーティのデータベースは、それぞれ異なる種類がサポートされます。 データベースプロバイダーのサポートには、が含まれ [!DNL Oracle]ます。
...
次のドキュメントは、APIまたはユーザーインターフェイス [!DNL Oracle] を [!DNL Platform] 使用した接続方法に関する情報を提供しています。
...
## UI [!DNL Oracle] を [!DNL Platform] 使用して接続
