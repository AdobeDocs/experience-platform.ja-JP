...
以下のドキュメントでは、API やユーザーインターフェイスを使用して [!DNL GreenPlum] を [!DNL Platform] に接続する方法について説明しています。

## API を使用して [!DNL GreenPlum] と [!DNL Platform] を接続する

- [Flow Service API を使用した GreenPlum ベース接続の作成](../../tutorials/api/create/databases/greenplum.md)
