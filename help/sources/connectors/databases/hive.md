...
# （Beta） [!DNL Apache Hive] コネクタの [!DNL Azure HDInsights]
...
[!DNL Experience Platform] では、サードパーティのデータベースからデータを取り込むことができます。 リレーショナル、NoSQL、データ・ウェアハウスなど、様々なタイプのデータベースに接続で [!DNL Experience Platform] ます。 データベースプロバイダーのサポートには、[!DNL Apache Hive] での [!DNL Azure HDInsights] が含まれます。
...
以下のドキュメントでは、API やユーザーインターフェイスを使用して、[!DNL Apache Hive] 上の [!DNL Azure HDInsights] を [!DNL Experience Platform] に接続する方法に関する情報を提供します。

## API を使用して [!DNL Apache Hive] の [!DNL Azure HDInsights] を [!DNL Experience Platform] に接続する
...
## UI を使用して [!DNL Apache Hive] の [!DNL Azure HDInsights] を [!DNL Experience Platform] に接続する
