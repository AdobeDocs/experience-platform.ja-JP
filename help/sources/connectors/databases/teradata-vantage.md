...
以下のドキュメントでは、API やユーザーインターフェイスを使用して [!DNL Teradata Vantage] と Platform を接続する方法について説明します。

## 接続 [!DNL Teradata Vantage] API を使用して Platform に接続
...
## 接続 [!DNL Teradata Vantage] UI を使用して Platform に接続
