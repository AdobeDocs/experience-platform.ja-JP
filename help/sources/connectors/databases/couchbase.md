...
以下のドキュメントでは、API やユーザーインターフェイスを使用して [!DNL Couchbase] を [!DNL Experience Platform] に接続する方法について説明しています。

## API を使用して [!DNL Couchbase] と [!DNL Experience Platform] を接続する
...
## UIを使用して [!DNL Couchbase] と [!DNL Experience Platform] を接続する
