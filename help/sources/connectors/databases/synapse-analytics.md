...
以下のドキュメントでは、API やユーザーインターフェイスを使用して [!DNL Azure Synapse Analytics] と を接続する方法について説明します。[!DNL Platform]
...
- [UI でのAzure synapseAnalytics ソース接続の作成](../../tutorials/ui/create/databases/synapse-analytics.md)
