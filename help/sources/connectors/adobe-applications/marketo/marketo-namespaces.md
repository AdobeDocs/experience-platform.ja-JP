...
| `TECHNICAL_ACCOUNT_ID` | [Adobe Developer Console](https://developer.adobe.com/)への統合に使用される資格情報。 テクニカルアカウント IDを取得するには、次の手順に従います。<ul><li>[Adobe Developer Console](https://developer.adobe.com/)に移動し、プロジェクトを開きます。</li><li>**サービスアカウント （JWT）**&#x200B;を使用する&#x200B;_資格情報_&#x200B;を開きます。 **注**：古いUIでは「エンタープライズ」と呼ばれることがあります。</li><li>資格情報の詳細には、クライアント ID、テクニカルアカウント ID、組織ID、その他のJWT メタデータが表示されます。</li></ul>。 | `D42AEVJZTTJC6LZADUBVPA15@techacct.adobe.com` |
...
| `PLATFORM_URL` | API呼び出しを行うURL エンドポイント。 この値は固定されており、常に`platform.adobe.io/`に設定されます。 | `platform.adobe.io/` |
