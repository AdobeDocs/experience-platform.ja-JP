...
>[!AVAILABILITY]
>
>- B2B スキーマが { リアルタイム顧客プロファイル [ に適合するには、{0](../../../../rtcdp/b2b-overview.md)Adobe Real-Time Customer Data Platform B2B edition[ へのアクセス権が必要です。](../../../../profile/home.md)
>
>- 2026 年 1 月以降、Real-Time CDP B2B editionは B2B エンティティ間の **非標準** 関係をサポートしなくなります。 したがって、[B2B 名前空間およびスキーマガイド ](../../../../rtcdp/schemas/b2b.md) に記載されている標準的な関係を使用するように B2B エンティティを更新することをお勧めします。
