---
keywords: Experience Platform；ホーム；人気のトピック；ソース；ソース；データ収集
...
Adobe Experience Platform Data Collection のソース統合により、ソースカタログを使用して、データ収集のためのデータ準備、警告のサポートの向上など、Edge Network上のデータにアクセスできます。
