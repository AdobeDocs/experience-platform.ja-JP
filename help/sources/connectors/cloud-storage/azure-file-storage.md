...
- [Flow Service APIを使用してAzure Fileストレージソース接続を作成する](../../tutorials/api/create/cloud-storage/azure-file-storage.md)
...
- [UIにAzure Fileストレージソース接続を作成する](../../tutorials/ui/create/cloud-storage/azure-file-storage.md)
