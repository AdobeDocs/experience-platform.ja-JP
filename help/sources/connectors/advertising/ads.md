---
keywords: Experience Platform；ホーム；人気のトピック；Google広告；google 広告
...
>[!NOTE]
>
>[!DNL Google Ads] ソースはベータ版です。を参照してください。 [ソースの概要](../../home.md#terms-and-conditions) ベータ版のコネクタの使用に関する詳細情報。
...
[!DNL Experience Platform] サードパーティの広告システムからデータを取り込む機能を提供します。 広告プロバイダーのサポートは次のとおりです [!DNL Google Ads].
