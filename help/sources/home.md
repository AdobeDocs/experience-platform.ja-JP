...
- [の作成 [!DNL Marketo Engage] UI でのソース接続](./tutorials/ui/create/adobe-applications/marketo.md)
...
CRM システムは顧客との関係を築くのに役立つデータを提供し、顧客との忠誠度を高め、顧客保持率を高めます。Experience Platformでは、 [!DNL Microsoft Dynamics 365] および [!DNL Salesforce]. 詳しくは、次の関連ドキュメントを参照してください。
...
ベータ版（以下、「ベータ版」）という名称のソースを使用することにより、お客様は、ベータ版が提供されることを承認します ***「現状のまま」何の保証もない***.
