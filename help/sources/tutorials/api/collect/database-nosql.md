...
Platformでソースデータを使用するには、ターゲットXDMスキーマを作成し、必要に応じてソースデータを構造化する必要があります。 次に、ターゲットXDMスキーマを使用して、ソースデータが含まれるプラットフォームデータセットを作成します。 このターゲットXDMスキーマは[!DNL XDM Individual Profile]クラスも拡張します。
