...
このチュートリアルに従うと、ソースコネクタを作成して、広告システムからスケジュールに基づいてデータを収集できます。 受信データは、リアルタイム顧客情報やData Science Workspaceなどのダウンストリームプラットフォームサービスで使用できるようになりました。 詳しくは、次のドキュメントを参照してください。
