...
ベース接続 ID を作成するには、 `/connections` エンドポイントを設定し、 [!DNL Salesforce] 認証資格情報（リクエスト本文）。
...
| `connectionSpec.id` | The [!DNL Salesforce] 接続仕様 ID: `cfc0fee1-7dc0-40ef-b73e-d8b134c436f5`. |
