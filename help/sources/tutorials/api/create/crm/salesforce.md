...
# [!DNL Flow Service] APIを使用して[!DNL Salesforce]コネクタを作成する
...
このチュートリアルでは、[!DNL Flow Service] APIを使用して、[!DNL Platform]を[!DNL Salesforce]アカウントに接続し、CRMデータを収集する手順を順を追って説明します。
