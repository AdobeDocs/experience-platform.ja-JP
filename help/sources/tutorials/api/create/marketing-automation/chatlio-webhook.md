...
## [!DNL Flow Service] API を使用した [!DNL Chatlio] の Platform への接続 {#connect-platform-to-flow-api}
...
[!DNL Chatlio] から Platform にデータを取り込むための最後の手順は、データフローを作成することです。 現時点で、次の必要な値の準備ができています。
