...
# Flow Service APIを使用してAzure Synapse Analyticsコネクタを作成する
...
このチュートリアルでは、Flow Service APIを使用して、Azure Synapse Analytics（以下「シナプス」と呼ばれる）をエクスペリエンスプラットフォームに接続する手順を順を追って説明します。
