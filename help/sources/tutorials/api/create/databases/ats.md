...
topic: overview
type: Tutorial
description: このチュートリアルでは、Flow Service APIを使用して、Azureテーブルストレージ（以下「ATS」と呼ばれる）をExperience Platformに接続する手順を順を追って説明します。
...
# [!DNL Flow Service] APIを使用して[!DNL Azure Table Storage]コネクタを作成する
