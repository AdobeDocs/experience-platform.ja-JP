...
Experience Platformでのチェンジ データ キャプチャには、**[モデルベースのスキーマ](../../../xdm/data-mirror/overview.md)** を持つ [0}Data Mirror} が必要です（リレーショナル スキーマとも呼ばれます）。 ](../../../xdm/schema/model-based.md)Data Mirrorに変更データを提供するには、次の 2 つの方法があります。
