...
[!DNL Platform] APIを呼び出すには、まず[認証チュートリアル](https://www.adobe.com/go/platform-api-authentication-en)を完了する必要があります。 次に示すように、認証チュートリアルを完了すると、すべてのE[!DNL xperience Platform] API呼び出しに必要な各ヘッダーの値が提供されます。
