...
title: UI のカスタマーサクセスソースを使用したデータフローの作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、カスタマーサクセスソースを持つ、認証済みアカウントが必要です。 UI で様々なカスタマーサクセスソースアカウントを作成するためのチュートリアルのリストは、次にあります [ソースの概要](../../../home.md#customer-success).
...
カスタマーサクセスソースアカウントを作成した後、 **[!UICONTROL データを追加]** 手順が表示され、カスタマーサクセスソースアカウントのテーブル階層を調べるためのインターフェイスが表示されます。
