...
title: UI の同意および環境設定Sourceを使用したデータフローの作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、[!DNL OneTrust Integration] ソースとの認証済みアカウントが必要です。 詳しくは、[UI での  [!DNL OneTrust Integration]  ソース接続の作成 ](../../ui/create/consent-and-preferences/onetrust.md) に関するチュートリアルを参照してください。
...
同意および環境設定のソースアカウントを作成すると、**[!UICONTROL データを追加]** 手順が表示され、同意および環境設定アカウントのテーブル階層を調べるためのインターフェイスが提供されます。
