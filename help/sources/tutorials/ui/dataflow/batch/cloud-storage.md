...
リストに表示されているフォルダーを選択すると、フォルダー階層を深いフォルダーに移動できます。 互換性のあるファイルまたはフォルダーを選択すると、[**[!UICONTROL データ形式を選択]**]ドロップダウンが表示され、プレビューーウィンドウにデータを表示する形式を選択できます。

![](../../../../images/tutorials/dataflow/cloud-storage/batch/select-data.png)

取り込むファイルに適切なデータ形式を選択し、プレビューーウィンドウにデータが入力されるまでの数秒間を許可します。

![](../../../../images/tutorials/dataflow/cloud-storage/batch/data-format.png)

区切りファイルを取り込む際に、カスタムの区切り文字を設定できます。 「**[!UICONTROL 区切り文字]**」オプションを選択し、ドロップダウンメニューから区切り文字を選択します。 このメニューには、カンマ(`,`)、タブ(`\t`)、パイプ(`|`)など、区切り文字に最も頻繁に使用されるオプションが表示されます。 または、「**[!UICONTROL カスタム]**」を選択し、ポップアップ入力バーに任意のカスタム区切り文字を入力します。
