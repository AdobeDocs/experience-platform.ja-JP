...
このチュートリアルに従うことで、データフローを作成し、支払いソースから Platform にデータを取り込むことができました。 [!DNL Real-time Customer Profile] や [!DNL Data Science Workspace] など、ダウンストリームの [!DNL Platform] サービスで受信データを使用できるようになりました。詳しくは、次のドキュメントを参照してください。
