...
title: UI のマーケティング自動処理Sourceを使用したデータフローの作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、マーケティング自動化ソースを持つ、認証済みアカウントが必要です。 UI で様々なマーケティング自動化のソースアカウントを作成するチュートリアルのリストについては、[ ソースの概要 ](../../../home.md#marketing-automation) を参照してください。
...
マーケティング自動化ソースアカウントを作成すると、**[!UICONTROL データを追加]** 手順が表示され、マーケティング自動化ソースアカウントのテーブル階層を調べるためのインターフェイスが提供されます。
