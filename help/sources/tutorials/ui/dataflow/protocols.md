...
title: UI のプロトコル Sourceを使用したデータフローの作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、プロトコルソースとの認証済みアカウントが必要です。 UI で様々なプロトコルソースアカウントを作成するためのチュートリアルのリストは、[ ソースの概要 ](../../../home.md#protocols) を参照してください。
