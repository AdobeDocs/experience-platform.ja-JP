...
title: UI でのプロトコル・ソース接続のデータ・フローの構成
...
さらに、このチュートリアルでは、既にプロトコルアカウントを作成している必要があります。 UI で様々なプロトコルコネクタを作成するためのチュートリアルのリストは、[ ソースコネクタの概要 ](../../../home.md) に記載されています。

## データの選択

プロトコルアカウントを作成すると、「**[!UICONTROL データを選択]**」手順が表示され、ファイル階層を調べるためのインタラクティブなインターフェイスが提供されます。
