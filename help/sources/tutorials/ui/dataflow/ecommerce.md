...
title: UI で E-Commerce Sourceを使用してデータフローを作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、e コマースソースを持つ認証済みアカウントが必要です。 UI で様々な e コマースソースアカウントを作成するためのチュートリアルのリストは、[ ソースの概要 ](../../../home.md#ecommerce) を参照してください。
...
e コマースソースアカウントを作成すると、**[!UICONTROL データを追加]** 手順が表示され、e コマースソースアカウントのテーブル階層を調べるためのインターフェイスが提供されます。
