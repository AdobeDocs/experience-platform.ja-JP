---
keywords: Experience Platform；ホーム；人気のトピック；e コマースコネクタ；e コマース
solution: Experience Platform
title: UI で E-Commerce ソースを使用してデータフローを作成
type: Tutorial
description: データフローは、ソースから Platform データセットにデータを取得して取り込む、スケジュールされたタスクです。 このチュートリアルでは、Platform UI を使用して e コマースソースのデータフローを作成する手順を説明します。
...
# UI で e コマースソースを使用してデータフローを作成

データフローは、ソースからAdobe Experience Platformのデータセットにデータを取得して取り込む、スケジュールされたタスクです。 このチュートリアルでは、Platform UI を使用して e コマースソースのデータフローを作成する手順を説明します。

>[!NOTE]
>
>* データフローを作成するには、e コマースソースを持つ認証済みアカウントが必要です。 UI で様々な e コマースソースアカウントを作成するためのチュートリアルのリストは、次にあります。 [ソースの概要](../../../home.md#ecommerce).
...
このチュートリアルでは、e コマースソースから Platform にデータを取り込むためのデータフローを正常に作成しました。 [!DNL Real-Time Customer Profile] や [!DNL Data Science Workspace] など、ダウンストリームの [!DNL Platform] サービスで受信データを使用できるようになりました。詳しくは、次のドキュメントを参照してください。
