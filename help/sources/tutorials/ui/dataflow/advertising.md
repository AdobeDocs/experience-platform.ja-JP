...
データフローとは、ソースからデータを取得し、Adobe Experience Platformタスクセットに取り込む、スケジュール済みのデータフローです。 このチュートリアルでは、広告アカウントを使用して新しいデータフローを設定する手順を説明します。
...
また、このチュートリアルでは、既に広告アカウントを作成している必要があります。 UIで異なる支払コネクタを作成するためのチュートリアルのリストは、ソースコネクタの概要 [を参照してください](../../../home.md)。

## データの選択

広告アカウントを作成すると、「デー *タの選択* 」手順が表示され、ファイル階層を調べるためのインタラクティブなインターフェイスが提供されます。
