...
title: UI でのAdvertising Sourceを使用したデータフローの作成
type: Tutorial
...
>[!NOTE]
>
>* データフローを作成するには、広告ソースとの認証済みアカウントが必要です。 UI で様々な広告ソースアカウントを作成するためのチュートリアルのリストは、[ ソースの概要 ](../../../home.md#advertising) を参照してください。
...
広告ソースアカウントを作成すると、**[!UICONTROL データを追加]** 手順が表示され、広告ソースアカウントのテーブル階層を調べるためのインターフェイスが提供されます。
