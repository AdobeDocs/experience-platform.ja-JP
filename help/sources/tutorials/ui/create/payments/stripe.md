---
title: ユーザーインターフェイスを使用して、StripeアカウントからExperience Platformに支払いデータを取り込みます。
description: ユーザーインターフェイスを使用してStripeアカウントからExperience Platformに支払いデータを取り込む方法を説明します。
badge: ベータ版
...
![Experience PlatformUI のソースカタログで、Stripeソースカードが選択されています。](../../../../images/tutorials/create/stripe/catalog.png)

**[!UICONTROL Stripeアカウントを接続]** ページが表示されます。 このページでは、新しい資格情報または既存の資格情報を使用できます。
