...
Platform で [!DNL Google Cloud Storage] データにアクセスするには、次の値を指定する必要があります。

| 資格情報 | 説明 |
| ---------- | ----------- |
| アクセスキー ID | [!DNL Google Cloud Storage] アカウントを Platform に認証するために使用される 61 文字の英数字の文字列。 |
| シークレットアクセスキー | [!DNL Google Cloud Storage] アカウントを Platform に認証するために使用される 40 文字の base-64 エンコード文字列。 |
...
![ ソースカタログページを表示する Platform UI 画面。](../../../../images/tutorials/create/google-cloud-storage/catalog.png)
...
![Google Cloud Storage ソースの既存のアカウントページを表示している Platform UI 画面 ](../../../../images/tutorials/create/google-cloud-storage/existing.png)
...
![Google Cloud Storage ソースの新しいアカウントページを表示している Platform UI 画面。](../../../../images/tutorials/create/google-cloud-storage/new.png)


## 次の手順

このチュートリアルでは、[!DNL Google Cloud Storage] アカウントとの接続を確立しました。次のチュートリアルに進み、[ データフローを設定して、クラウドストレージから Platform にデータを取り込む ](../../dataflow/batch/cloud-storage.md) ことができます。
