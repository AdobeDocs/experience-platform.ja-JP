...
**[!UICONTROL Databases]**&#x200B;カテゴリーの下で、**[!UICONTROL OracleDB]**&#x200B;を選択します。 このコネクタを初めて使用する場合は、**[!UICONTROL 設定]**&#x200B;を選択します。 それ以外の場合は、**[!UICONTROL 追加data]**&#x200B;を選択して新しい[!DNL Oracle DB]コネクタを作成します。
