...
Adobe Experience Platformのソースコネクタは、外部ソースのデータをスケジュールに基づいて取り込む機能を提供します。 このチュートリアルでは、Platformユーザーインターフェイスを使用してGreenPlumソースコネクタを作成する手順を説明します。
...
必要な資格情報を収集したら、次の手順に従って新しいGreenPlumアカウントを作成し、Platformに接続します。
...
このチュートリアルに従って、GreenPlumアカウントとの接続を確立しました。 次のチュートリアルに進み、データをPlatformに取り込むようにデータフローを [設定できます](../../dataflow/databases.md)。