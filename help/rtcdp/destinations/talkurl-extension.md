---
title: Talk URL Inbox拡張
seo-title: トークURL受信トレイ
description: Talk URL Inbox拡張は、Adobe Real-time Customer DataPlatformでの顧客の宛先の音声です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Talk URL Inbox拡張は、Adobe Real-time Customer DataPlatformでの顧客の宛先の音声です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Webページの訪問者から音声メッセージを受信します。 ホストUIとクラウドベースの機械学習が含まれ、音声メッセージを即座にテキストインサイトに書き込みます。

[!DNL Talk URL Inbox] は、アドビのリアルタイム顧客データPlatformにおける顧客拡張機能の音声です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100583.html)。
...
![Talk URL Inbox拡張](assets/talkurl-extension.png)
...
拡張機能をインストールするに [!DNL Talk URL Inbox] は：
...
拡張機能の構成オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [トークURLインボックスページを参照してください](https://exchange.adobe.com/experiencecloud.details.100583.html)。
