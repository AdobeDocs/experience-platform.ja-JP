---
title: Pinterestコンバージョントラッキングの拡張
seo-title: Pinterestコンバージョントラッキングの拡張
description: Pinterestコンバージョントラッキング拡張機能は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Pinterestコンバージョントラッキング拡張機能は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# Pinterestコンバージョントラッキングの拡張 {#pinterest-extension}

## 概要 {#overview}

プロモーションPINの表示後、Webサイトでの訪問者操作を追跡します。 広告費収益率を測定し、ターゲットを絞ったオーディエンスを作成します。 詳しくは[こちら](https://ads.pinterest.com/)。

Pinterestコンバージョントラッキングは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)。
...
![Pinterestコンバージョントラッキングの拡張](assets/pinterest-extension.png)
...
Pinterestコンバージョントラッキング拡張機能をインストールするには：
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [Pinterestコンバージョンの追跡ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)。
