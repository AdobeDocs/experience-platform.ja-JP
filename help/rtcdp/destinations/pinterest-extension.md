---
title: Pinterestコンバージョントラッキング拡張
seo-title: Pinterestコンバージョントラッキング拡張
description: Pinterestコンバージョントラッキング拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Pinterestコンバージョントラッキング拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# Pinterestコンバージョントラッキング拡張 {#pinterest-extension}

## 概要 {#overview}

プロモーションされたPINの訪問者後に、Webサイト上での表示操作を追跡します。 広告費収益率を測定し、ターゲットを絞ったオーディエンスを作成。 詳しくは[こちら](https://ads.pinterest.com/)。

Pinterestコンバージョントラッキングは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)。
...
![Pinterestコンバージョントラッキング拡張](assets/pinterest-extension.png)
