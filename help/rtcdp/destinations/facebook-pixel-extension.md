---
title: Facebookピクセル拡張
seo-title: Facebookピクセル拡張
description: Facebookピクセル拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# Facebookピクセル拡張 {#facebook-pixel-extension}

## 概要 {#overview}

Facebookのピクセルは分析ツールで、Webサイトで人々がとる行動を把握することで、広告の効果を測定できます。

Facebookピクセルは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能について詳しくは、 [FacebookピクセルのWebサイトを参照してください](https://developers.facebook.com/docs/facebook-pixel/)。
...
![Facebookピクセル拡張](assets/facebook-pixel-extension.png)
