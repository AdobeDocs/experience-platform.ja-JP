...
title: 量子指標の拡張
seo-title: 量子指標の拡張
description: Quantum Metric拡張は、Adobe Real-time Customer Data Platformの解析の宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Quantum Metric拡張は、Adobe Real-time Customer Data Platformの分析の宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# 量子指標拡張 {#quantum-metric-extension}

## 概要 {#overview}

Quantum MetricとAdobe Launchの統合により、Quantum Metricのデータ収集タグのコードレス導入が容易になります。 さらに、この拡張機能では、Quantum Metric APIから有用な情報を含むLaunch Data Elementsをオファーできます。

Quantum Metricは、Adobe Real-time Customer Data Platformの解析拡張です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)。
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [Quantum Metricページを参照してください](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)。
