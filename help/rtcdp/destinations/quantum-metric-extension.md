...
title: 量子指標拡張
seo-title: 量子指標拡張
description: Quantum Metricの拡張機能は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Quantum Metric拡張機能は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Quantum MetricのAdobe Launchとの統合により、Quantum Metricのデータ収集タグのコードレス導入が容易になります。 さらに、この拡張機能は、Quantum Metric APIから役立つ情報を含むLaunch Data Elementsをキャプチャする機能をオファーします。

Quantum Metricは、Adobe Real-time Customer Data PlatformのAnalytics拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)。
