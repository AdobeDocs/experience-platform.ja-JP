...
description: Experience Cloud IDサービスの拡張機能は、Adobe Real-time Customer Data Platformのパーソナライズの対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Experience Cloud IDサービスの拡張機能は、Adobe Real-time Customer Data Platformのパーソナライズの対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Experience Cloud IDサービスは、アドビのリアルタイム顧客データプラットフォームにおけるパーソナライズ機能の拡張です。 拡張機能の機能について詳しくは、Experience Platform Launchドキュメントの [Experience Cloud IDサービス拡張のページ](https://docs.adobe.com/content/help/ja-JP/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) を参照してください。
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Experience Launchドキュメントの [Experience Cloud IDサービスの拡張機能ページ](https://docs.adobe.com/content/help/ja-JP/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) を参照してください。
