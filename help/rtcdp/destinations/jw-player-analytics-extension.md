...
拡張機能の設定オプションについて詳しくは、 [Adobe Exchangeの](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) JW Player Analytics(BETA)拡張機能ページを参照してください。
