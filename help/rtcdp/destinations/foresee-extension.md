...
title: Forese拡張
seo-title: Forese拡張
description: Forese拡張機能は、Adobe Real-time Customer DataPlatformの調査先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Experience Platform Launchを使用して [!DNL ForeSee] 製品の導入を設定します。

[!DNL Foresee] は、アドビのリアルタイム顧客データPlatformの調査拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100164.html)。
