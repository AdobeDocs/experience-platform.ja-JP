...
title: Forese拡張
seo-title: Forese拡張
description: Forese拡張機能は、Adobe Real-time Customer Data Platformの調査先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# Forese拡張 {#foresee-extension}

## 概要 {#overview}

Experience Platform Launchを使用して、ForeSee製品の導入を設定します。

Foreseは、Adobe Real-time Customer Data Platformの調査拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100164.html)。
...
拡張機能の設定オプションについて詳しくは、Adobe Exchangeの [Forese拡張機能ページ](https://exchange.adobe.com/experiencecloud.details.100164.html) を参照してください。
