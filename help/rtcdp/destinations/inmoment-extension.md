---
title: InMoment拡張
seo-title: InMoment拡張
description: InMoment拡張機能は、Adobe Real-time Customer Data Platformの調査先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# InMoment拡張 {#inmoment-extension}

## 概要 {#overview}

InMoment Launch統合を使用すると、Digital Intercept製品を介したオンラインフィードバックをすばやく簡単に有効にできます。 CXI Cloud管理者を介してインターセプトを構成および管理することで、CXマネージャはプログラムをより詳細に制御できます。

InMomentは、Adobe Real-time Customer Data Platformの調査拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100847.html)。
...
![Inment延長](/help/rtcdp/destinations/assets/inmoment-extension.png)
...
拡張機能の設定オプションについて詳しくは、Adobe Exchangeの [Google Universal Analytics拡張機能ページ](https://exchange.adobe.com/experiencecloud.details.100847.html) を参照してください。
