...
description: InMoment拡張は、Adobe Real-time Customer Data Platformの調査先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
InMoment Launch統合を使用すると、Digital Intercept製品を介したオンラインフィードバックを迅速かつ容易に有効にできます。 このアプリでは、インターセプトの設定と管理をCXI Cloud管理者経由で行い、CXマネージャがプログラムをより詳細に制御できるようにします。

InMomentは、Adobe Real-time Customer Data Platformの調査拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.100847.html)。
...
拡張機能の設定オプションについて詳しくは、Adobe Exchangeの [Google Universal Analytics拡張機能ページを参照](https://exchange.adobe.com/experiencecloud.details.100847.html) してください。
