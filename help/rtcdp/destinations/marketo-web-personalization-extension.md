...
description: Marketto Web Personalization Extensionは、アドビのリアルタイム顧客データプラットフォームでのパーソナライズの対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Marketto Web Personalization Extensionは、アドビのリアルタイム顧客データプラットフォームでのパーソナライズの対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
この拡張機能により、マーケティング担当者のWebパーソナライゼーションおよびContentAIアプリケーションのスクリプトがデプロイされます。 マーケティング先Webパーソナライゼーションは、匿名訪問者のファームグラフィックや、既知の訪問者に関するMarketo Engagement Platform内の幅広い行動属性など、Web訪問者の特性に対するコンテンツを一意に識別し、パーソナライズします。 Marketo ContentAIには、B2Bのお客様に特有のWebキャンペーンや電子メールユーザー向けの、AIに基づくレコメンデーションおよびパーソナライゼーションの機能が含まれています。

マーケティングツールWebパーソナライゼーションは、アドビのリアルタイム顧客データプラットフォームにおけるパーソナライゼーション拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html)。
