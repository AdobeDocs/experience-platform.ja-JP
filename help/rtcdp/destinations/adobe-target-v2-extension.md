...
description: Adobeターゲットv2拡張機能は、Adobe Real-time Customer Data Platformでのパーソナライズの対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Adobeターゲットv2は、Adobe Real-time Customer Data Platformのパーソナライゼーション拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html)。
...
拡張機能の設定オプションについて詳しくは、エクスペリエンス起動ドキュメントの [Adobeターゲットv2拡張機能ページ](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/targetv2-extension/adobe-target-extension-v2.html) を参照してください。
