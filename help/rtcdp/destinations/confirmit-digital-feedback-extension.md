---
title: Confirm Digital Feedback extension
seo-title: Confirm Digital Feedback extension
description: デジタルフィードバックの確認拡張は、Adobe Real-time Customer Data Platformの顧客宛先の音声です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
Confirm Digital Feedbackソリューションは、Webサイトのトラフィックをリアルタイムのインサイトに変えるのに役立ちます。 確認を行うと、押し付けがましく、ターゲットを絞った調査を要件に従って表示でき、次のようなフィードバックを訪問者に提供するよう促すことができます。
...
Adobe Real-time Customer Data PlatformのVoice of the Customer extensionであることを確認します。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)。
...
![Confirm Digital Feedback extension](assets/confirmit-digital-feedback-extension.png)
...
Confirm Digital Feedback拡張機能をインストールするには：
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの「デジタル [フィードバックの確認」ページを参照してください](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)。
