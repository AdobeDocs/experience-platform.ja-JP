...
title: 勝者拡張
seo-title: 勝者拡張
description: Gainsight拡張機能は、Adobe Real-time Customer Data Platformのパーソナライゼーション先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Gainsight拡張機能は、Adobe Real-time Customer Data Platformのパーソナライゼーション先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# 勝者拡張 {#gainsight-extension}

## 概要 {#overview}

Gainsightは、ユーザの行動を深く理解し、製品の採用を促進し、ユーザのフィードバックを収集するツールを製品所有者に提供します。

Gainsightは、Adobe Real-time Customer Data Platformのパーソナライゼーション拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
...
![勝者拡張](assets/gainsight-extension.png)
...
拡張機能の構成オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [Gainsightページを参照してください](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
