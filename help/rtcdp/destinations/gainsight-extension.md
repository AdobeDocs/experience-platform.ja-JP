...
title: 勝者拡張
seo-title: 勝者拡張
description: Gainsight拡張機能は、アドビのリアルタイム顧客データPlatformでのパーソナライゼーションの宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Gainsight拡張機能は、アドビのリアルタイム顧客データPlatformでのパーソナライゼーションの宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
[!DNL Gainsight] 製品所有者に、ユーザーの行動を深く理解し、製品の採用を促進し、ユーザーのフィードバックを収集するツールを提供します。

[!DNL Gainsight] は、アドビのリアルタイム顧客データPlatformでのパーソナライゼーション拡張です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
...
拡張機能をインストールするに [!DNL Gainsight] は：
