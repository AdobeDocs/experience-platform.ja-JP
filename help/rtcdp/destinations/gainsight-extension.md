...
title: 勝者拡張
seo-title: 勝者拡張
description: Gainsight拡張機能は、Adobe Real-time Customer Data Platformのパーソナライゼーションの宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Gainsight拡張機能は、Adobe Real-time Customer Data Platformのパーソナライゼーションの宛先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
Gainsightは、ユーザの行動を深く理解し、製品の採用を推進し、ユーザのフィードバックを収集するツールを製品所有者に提供します。

Gainsightは、Adobe Real-time Customer Data Platformのパーソナライゼーション拡張です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
...
拡張機能の構成オプションとインストールのサポートについて詳しくは、Adobe Exchangeの「勝 [者」ページを参照してください](https://www.adobeexchange.com/experiencecloud.details.103343.html)。
