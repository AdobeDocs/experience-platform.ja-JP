---
title: Googleのgtag拡張
seo-title: Googleのgtag拡張
description: Googleタグ拡張機能は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# Googleのgtag拡張 {#gtag-advertising-extension}

## 概要 {#overview}

Googleのデータをサイト `gtag.js` に読み込んで、Google Analytics、Google Ads、Google Marketing Platformにイベントデータを送信します。 この拡張機能は、タグコードをサイトに追加するだけです。 他のGoogle拡張機能を使用して、タグを使用するイベントやアクションを追加する必要があります。

Googleタグは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)。
...
![Googleのgtag拡張](/help/rtcdp/destinations/assets/gtag-advertising-extension.png)
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [Google gtagページを参照してください](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)。
