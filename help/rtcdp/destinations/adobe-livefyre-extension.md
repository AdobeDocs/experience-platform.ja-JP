...
description: Adobe Livefyre拡張機能は、Adobeリアルタイム顧客データPlatformのソーシャルターゲットです。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Adobe Livefyreは、Adobe Real-time Customer DataPlatformのソーシャル拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100464.html)。
