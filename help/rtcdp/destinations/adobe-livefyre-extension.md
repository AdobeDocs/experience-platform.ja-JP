---
title: Adobe Livefyre拡張機能
seo-title: Adobe Livefyre拡張機能
description: Adobe Livefyre拡張機能は、Adobe Real-time Customer Data Platformのソーシャルターゲットです。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Adobe Livefyreを使用すると、ユーザー生成コンテンツの絶え間ないフローを見つけ出し、整理し、Webサイトに公開して、パーソナライズされた本格的なエクスペリエンスを作成できます。

Adobe Livefyreは、Adobe Real-time Customer Data Platformのソーシャル拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100464.html)。
...
![Adobe Livefyre拡張機能](/help/rtcdp/destinations/assets/adobe-livefyre-extension.png)
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [Adobe Livefyreページを参照してください](https://exchange.adobe.com/experiencecloud.details.100464.html)。
