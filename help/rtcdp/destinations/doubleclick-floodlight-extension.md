---
title: DoubleClick Floodlight（ベータ）拡張
seo-title: DoubleClick Floodlight（ベータ）拡張
...
# DoubleClick Floodlight（ベータ）拡張

## 概要 {#overview}

この拡張機能を使用すると、（グローバルサイトタグではなく）従来のFloodlight形式を使用して、DoubleClick Floodlightタグを迅速かつ簡単にデプロイできます。 注意：この拡張機能はベータ版です。
