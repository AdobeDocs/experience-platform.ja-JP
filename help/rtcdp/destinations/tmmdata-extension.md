...
title: TMMData拡張
seo-title: TMMData拡張
description: TMMData拡張は、Adobe Real-time Customer Data Platformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: TMMData拡張は、Adobe Real-time Customer Data Platformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# TMMData拡張 {#tmmdata-extension}

## 概要 {#overview}

TMMDataのFoundation platform for Adobe Marketing Cloudは、社内/外部およびオンライン/オフラインデータを含む重要なデータソースにアクセスしてブレンドするツールをマーケティングチームに提供し、包括的なクロスチャネル分析を確実に行い、キャンペーン設定を自動化し、他の分析やBIツールに直接インポートします。

TMMDataは、Adobe Real-time Customer Data PlatformのAnalytics拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
...
![TMMData拡張](assets/tmmdata-extension.png)
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [TMMDataページを参照してください](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
