...
[!DNL TMMData's] Adobe Marketing Cloudの基盤プラットフォームは、内部/外部データ、オンライン/オフラインデータなど、重要なデータソースにアクセスし、ブレンドするツールをマーケティングチームに提供し、包括的なクロスチャネル分析と、自動キャンペーン設定や他の解析およびBIツールを提供します。
...
![TMMData 拡張機能](assets/tmmdata-extension.png)
