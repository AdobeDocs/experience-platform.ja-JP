...
title: TMMData拡張
seo-title: TMMData拡張
description: TMMData拡張は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: TMMData拡張は、Adobe Real-time Customer Data Platformの解析の送信先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
TMMDataのFoundation platform for Adobe Marketing Cloudは、社内/外部データ、オンライン/オフラインデータなど、重要なデータソースにアクセスしてブレンドするツールをマーケティングチームに提供し、チャネル間の分析を確実に行います。

TMMDataは、Adobe Real-time Customer Data PlatformのAnalytics拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
...
拡張機能の構成オプションとインストールのサポートについて詳しくは、Adobe Exchangeの [TMMDataページを参照してください](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)。
