...
![概要 - 宛先の作成手順とセグメントのアクティブ化の手順](/help/rtcdp/destinations/assets/flow-api-destinations-steps-overview.png)

アドビのリアルタイム CDP のユーザーインターフェイスを使用して宛先を接続し、データをアクティブ化する場合は、[宛先の接続](../../rtcdp/destinations/connect-destination.md)に関するチュートリアル、および[宛先に対するプロファイルとセグメントのアクティブ化](../../rtcdp/destinations/activate-destinations.md)に関するチュートリアルを参照してください。
...
![宛先の指定手順の概要 - 手順 1](/help/rtcdp/destinations/assets/flow-api-destinations-step1.png)
...
![宛先の指定手順の概要 - 手順 2](/help/rtcdp/destinations/assets/flow-api-destinations-step2.png)
...
![宛先の指定手順の概要 - 手順 3](/help/rtcdp/destinations/assets/flow-api-destinations-step3.png)
...
![宛先の指定手順の概要 - 手順 4](/help/rtcdp/destinations/assets/flow-api-destinations-step4.png)
...
![宛先の指定手順の概要 - 手順 5](/help/rtcdp/destinations/assets/flow-api-destinations-step5.png)
...
![宛先の指定手順の概要 - 手順 6](/help/rtcdp/destinations/assets/flow-api-destinations-step6.png)
