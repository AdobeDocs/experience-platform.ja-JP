...
description: Contentsquareの拡張機能は、Adobe Real-time Customer DataPlatformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Contentsquareの拡張機能は、Adobe Real-time Customer DataPlatformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
ページ内の行動を視覚化するには、「顧客が放棄した理由」と「改善策」を参照してください。 売上高は、各AnalyticsセグメントとTargetテストのUX要素とコンテンツ要素に属する。 タグをインストールし、カスタム変数とイベントを [!DNL Contentsquare] 設定します。 数回のクリックでUX分析のデータを収集する開始。

[!DNL Contentsquare] は、アドビのリアルタイム顧客データPlatformのanalytics拡張です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100364.html)。
...
拡張機能設定オプションについて詳しくは、Adobe Exchangeの [Contentsquare拡張機能ページ](https://exchange.adobe.com/experiencecloud.details.100364.html) を参照してください。
