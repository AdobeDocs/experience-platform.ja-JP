---
title: Contentsquare拡張子
seo-title: Contentsquare拡張子
description: Contentsquare拡張は、Adobe Real-time Customer Data Platformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Contentsquare拡張は、Adobe Real-time Customer Data Platformの解析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# Contentsquare拡張子 {#contentsquare-extension}

## 概要 {#overview}

ページ内の行動を視覚化する方法については、「顧客が放棄した理由」と「改善策」を参照してください。 売上高を、各Analyticsセグメントおよび各AnalyticsテストのUX要素とコンテンツ要素に属性ターゲットします。 Contentsquareタグをインストールし、カスタム変数とイベントを設定 開始が数回のクリックでUX分析のデータを収集。

Contentsquareは、Adobe Real-time Customer Data PlatformのAnalytics拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.100364.html)。
...
![Contentsquare拡張子](assets/contentsquare-extension.png)
...
拡張機能の設定オプションについて詳しくは、Adobe Exchangeの [Contentsquare拡張機能ページ](https://exchange.adobe.com/experiencecloud.details.100364.html) を参照してください。
