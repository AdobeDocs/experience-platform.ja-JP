...
description: Clicktale拡張機能は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Clicktale拡張機能は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Clicktaleとエクスペリエンスプラットフォーム起動の統合により、Clicktaleコードのデプロイメントや、Clicktaleのビジュアルエディターを使用したLaunch内のデータ要素のマッピング機能が可能になります。

クリックテールは、アドビのリアルタイム顧客データプラットフォームにおける分析拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.100082.html)。
...
拡張機能の設定オプションについて詳しくは、Adobe Exchangeの [Clicktale拡張機能ページ](https://exchange.adobe.com/experiencecloud.details.100082.html) を参照してください。
