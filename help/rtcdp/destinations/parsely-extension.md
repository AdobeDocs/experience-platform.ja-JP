---
title: Parse.ly Analytics拡張機能
seo-title: Parse.ly Analytics拡張機能
description: Parse.ly Analyticsの拡張機能は、Adobe Real-time Customer Data Platformの分析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Parse.ly Analytics拡張機能は、アドビのリアルタイム顧客データプラットフォームの分析先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# Parse.ly Analytics拡張機能 {#parsely-analytics-extension}

## 概要 {#overview}

Parse.ly Analyticsは、2,500人以上の会社がデータを使用してオンラインオーディエンスを理解するのに役立ちます。 この拡張機能により、訪問者がサイト上のコンテンツとやり取りする方法を追跡するJavaScriptスニペットがインストールされます。

Parse.lyは、Adobe Real-time Customer Data PlatformのAnalytics拡張機能です。 拡張機能について詳しくは、 [Parse.ly Analyticsを参照してください](https://www.parse.ly/)。
...
![Parse.ly Analytics拡張機能](assets/parsely-extension.png)
