---
title: DialogTech拡張機能
seo-title: DialogTech拡張機能
description: DialogTech拡張機能は、Adobe Real-time Customer Data Platformの解析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: DialogTech拡張機能は、Adobe Real-time Customer Data Platformの解析の対象となります。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# DialogTech拡張機能 {#dialogtech-extension}

## 概要 {#overview}

Adobe LaunchにDialogTech SourceTrakのjavascriptスニペットを含める

DialogTechは、Adobe Real-time Customer Data Platformの分析拡張機能です。 拡張機能について詳しくは、DialogtechのWebサイトを参照して [ください](https://www.dialogtech.com/)。
...
![DialogTech拡張機能](assets/dialogtech-extension.png)
