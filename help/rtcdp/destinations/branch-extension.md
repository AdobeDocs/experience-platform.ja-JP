...
title: ブランチの拡張
seo-title: ブランチの拡張
description: Branch拡張機能は、アドビのリアルタイム顧客データPlatformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Branch拡張機能は、アドビのリアルタイム顧客データPlatformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
# [!DNL Branch] 拡張機能 {#branch-extension}

## 概要 {#overview}

Branchは、すべてのデバイス、チャネル、プラットフォームにわたって、顧客を獲得、関与、測定するための強力なリンクとソリューションを提供します。

Branchは、アドビのリアルタイム顧客データPlatformにおける広告の拡張機能です。 拡張機能について詳しくは、ブランチWebサイトの [機能ページ](https://branch.io/features/) を参照してください。
