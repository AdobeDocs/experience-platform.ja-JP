...
title: ブランチの拡張
seo-title: ブランチの拡張
description: Branch拡張機能は、アドビのリアルタイム顧客データプラットフォームの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
seo-description: Branch拡張機能は、アドビのリアルタイム顧客データプラットフォームの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
Branchは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能について詳しくは、ブランチWebサイトの [機能ページ](https://branch.io/features/) を参照してください。
