...
title: ブランチの拡張
seo-title: ブランチの拡張
description: Branch拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Branch拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# ブランチの拡張 {#branch-extension}

## 概要 {#overview}

Branchは、すべてのデバイス、デバイス、プラットフォームにわたって、顧客を獲得、惹きつけ、測定するための強力なリンクとソリューションを提供します。チャネルは、

ブランチは、Adobe Real-time Customer Data Platformの広告拡張です。 拡張機能について詳しくは、ブランチWebサイトの機 [能のページ](https://branch.io/features/) を参照してください。
...
![ブランチの拡張](assets/branch-extension.png)
