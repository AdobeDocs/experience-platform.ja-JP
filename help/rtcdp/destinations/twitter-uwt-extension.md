...
description: Twitter Universal Webサイトタグ拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
seo-description: Twitter Universal Webサイトタグ拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# TwitterユニバーサルWebサイトタグ拡張 {#twitter-uwt-extension}

## 概要 {#overview}

TwitterユニバーサルWebサイトタグは、Twitter UWTタグにビーコンを送信するアクションを提供します。

Twitter Universal Webサイトタグは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能について詳しくは、「アドバンスコンバージョントラッキ [ング」を参照してくださ](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)い。
...
TwitterユニバーサルWebサイトタグ拡張をインストールするには：
