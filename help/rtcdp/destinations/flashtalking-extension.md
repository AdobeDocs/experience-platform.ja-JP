---
title: Flashtalking OneTag拡張
seo-title: Flashtalking OneTag拡張
description: Flashtalking OneTag拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能のページを参照してください。
...
# Flashtalking OneTag拡張 {#flashtalking-extension}

## 概要 {#overview}

Flashtalking OneTag extension for Experience Platform Launchを使用すると、サイトのアクションを簡単に属性化して、表示、ビデオ、モバイル広告アクティビティを表示できます。 「起動」を使用して、Flashtalking OneTagをWebプロパティに導入します。

Flashtalking OneTagは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能のページを参照してください](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)。
...
![Flashtalking拡張](assets/flashtalking-extension.png)
...
Flashtalking OneTag拡張をインストールするには：
...
拡張機能の設定オプションとインストールのサポートについて詳しくは、Adobe ExchangeのFlashtalking OneTag [ページを参照してください](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)。
