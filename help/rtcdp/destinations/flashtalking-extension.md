...
description: Flashtalking OneTag拡張は、Adobe Real-time Customer Data Platformの広告先です。 拡張機能の詳細については、Adobe Exchangeの拡張機能ページを参照してください。
...
エクスペリエンスプラットフォームの起動のFlashtalking OneTag拡張機能を使用すると、サイトのアクションを簡単に関連付けて、表示、ビデオ、モバイル広告アクティビティを行うことができます。 「起動」を使用して、Flashtalking OneTagをWebプロパティに導入します。

Flashtalking OneTagは、Adobe Real-time Customer Data Platformの広告拡張機能です。 拡張機能の詳細については、 [Adobe Exchangeの拡張機能ページを参照してください](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)。
...
拡張機能の構成オプションとインストールのサポートについて詳しくは、Adobe ExchangeのFlashtalking OneTagページを参照して [ください](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)。
