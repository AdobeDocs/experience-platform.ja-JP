...
[!DNL Bing Ads Universal Event Tracking] (UET)は、Adobeのリアルタイム顧客データPlatformの広告拡張機能です。 拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html) の拡張機能のページを参照してください。
...
![Bing Ads 拡張](assets/bing-extension.png)
