...
>[!IMPORTANT]
>
>アカウントプロファイルでは、データを表示するために、毎日のバッチセグメント化評価を有効にする必要があります。 正確なアカウントプロファイル情報を維持するために、バッチセグメント化が設定され、スケジュールされていることを確認します。 詳しくは、[ バッチセグメントガイド ](../../segmentation/methods/batch-segmentation.md) を参照してください。
