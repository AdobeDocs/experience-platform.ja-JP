...
検索バーを使用して、「Partner ID」イベントを見つけ、計算済み属性キャンバスに追加できます。
...
![「ルールを作成」ボタンがハイライト表示されています。](../assets/offsite-retargeting/select-build-rule.png)

セグメントビルダーページが表示されます。 このページでは、コンポーネントを使用してオーディエンスを構築できます。

![セグメントビルダー が表示されます。](../assets/offsite-retargeting/segment-builder.png)
...
計算済み属性を追加するには、次の場所にあります。 **[!UICONTROL 属性]**&#x200B;を選択します。 **[!UICONTROL XDM 個人プロファイル]**&#x200B;に続いて **[!UICONTROL _atag]**, **[!UICONTROL SystemComputedAttributes]**、および **[!UICONTROL PartnerID]**. 次に、 **[!UICONTROL 値]** の計算済み属性をキャンバスの「属性」セクションに追加します。
...
![「宛先に対してアクティブ化」ボタンがハイライト表示されています。](../assets/offsite-retargeting/activate-to-destination.png)
