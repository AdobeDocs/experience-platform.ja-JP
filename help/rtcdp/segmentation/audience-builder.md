...
![属性の統計を表示するポップオーバー。最小値、平均値、最大値を含みます。](../assets/segmentation/audience-builder/statistics.png)
...
![属性の取り込みタイプが表示されます。](/help/rtcdp/assets/segmentation/audience-builder/ingestion-type.png)
