...
![概要データを含む属性が表示されます。](/help/rtcdp/assets/segmentation/audience-builder/attribute-summary.png)

ドロップダウンを使用して、上位の値から選択するか、値を入力すると、上位の値のいずれかに自動的に解決されます。

![属性の値を追加できるドロップダウンがハイライト表示されます。](/help/rtcdp/assets/segmentation/audience-builder/attribute-summary-dialog.png)

>[!NOTE]
>
>概要データは&#x200B;**日単位**&#x200B;で更新されます。 さらに、値が配列またはキーと値のペアである属性では、概要データは&#x200B;**not** サポートされています。
