...
このジャーニーは、買い物かごに入れられたが、Web サイトとアプリの両方で購入されなかった製品をターゲットにします。 有料メディアキャンペーンの開始と停止に使用します
...
このジャーニーは、Web サイトとアプリの両方で製品の購入をターゲットに設定します。
...
### スキーマデザインとフィールドグループの設定

インテリジェントな再エンゲージメントジャーニーには、4 つのスキーマ設計が使用されています。 各スキーマでは、特定のフィールドを設定する必要があります。また、推奨されるフィールドもいくつか必要です。

>[!BEGINTABS]

>[!TAB 顧客属性（プロファイルスキーマ）]

プロファイルスキーマに必要なフィールドグループは次のとおりです。
...
![フィールドグループのリストを示す顧客属性スキーマの記録。](../intelligent-re-engagement/images/customer-attributes.gif)

>[!TAB 顧客のデジタルトランザクション]

(Adobe Analytics Connector ではなく ) オンラインアクティビティのエクスペリエンスイベントスキーマに必要なフィールドグループは、次のとおりです。
...
![フィールドグループのリストを示す顧客デジタルトランザクションスキーマの記録。](../intelligent-re-engagement/images/customer-digital-transactions.gif)

>[!TAB 顧客のオフライントランザクション]

オフラインアクティビティのエクスペリエンスイベントスキーマに必要なフィールドグループは次のとおりです。
...
![フィールドグループのリストを表示する顧客オフライントランザクションスキーマの記録。](../intelligent-re-engagement/images/customer-offline-transactions.gif)

>[!TAB AdobeWeb コネクタのスキーマ]
...
![フィールドグループのリストを示すAdobeWeb コネクタスキーマの記録です。](../intelligent-re-engagement/images/adobe-web-connector.png)
...
次のイベントは、プロファイルが製品をオンラインで表示し、次の 24 時間に買い物かごに追加されず、その後 3 日間はブランドエンゲージメントがおこなわれなかった再エンゲージメントジャーニーに使用されます。
