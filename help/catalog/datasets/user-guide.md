...
>additional-url="https://experienceleague.adobe.com/ja/docs/journey-optimizer/using/data-management/lookup-aep-data" text="Journey Optimizer での Adobe Experience Platform の使用"
...
プロファイルで有効になっているかどうかに基づいてデータセットをフィルタリングするには、フィルターオプションから「[!UICONTROL Yes]」チェックボックスを選択します。
