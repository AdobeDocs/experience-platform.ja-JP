...
* [Adobe Experience Platformセグメントサービス](../../segmentation/home.md): セグメントを作成し、 [!DNL Real-time Customer Profile] データからオーディエンスを生成できます。 These audiences can then be exported to their own datasets within the [!DNL Data Lake].
