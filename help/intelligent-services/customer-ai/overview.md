...
- 顧客 AI は製品のレコメンデーションツールではありません。何千もの SKU がある場合は、のような実際の製品レコメンデーションソリューションのプロキシとして顧客 AI を使用しないでください [!DNL Adobe Target].
...
『[始める前に](./getting-started.md)』に従って、作業を開始できます。このガイドでは、顧客 AI に必要なすべての前提条件を設定する手順について説明します。 すべての資格情報とデータが既に用意されている場合は、  [顧客 AI インスタンスの設定](./user-guide/configure.md). 顧客 AI を使用する手順について説明します。
