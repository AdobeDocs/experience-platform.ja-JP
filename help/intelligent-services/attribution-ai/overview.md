...
Attribution AIデータは、Adobeのデータソース（[!DNL Analytics] など）でも、Adobe以外のデータソースでもかまいません。
...
- **フルファネルアトリビューション**：カスタマージャーニー全体にわたるマーケティングの影響を理解します。 例えば、有料コンバージョン以降も継続される無料アカウントサインアップなど。
- **パートナー評価**：アトリビューション結果に基づいて、代理店やパートナーの有効性を評価します。

### その他の機能

Attribution AIは、[!DNL Customer Journey Analytics] などの他のAdobeソリューションとの統合も提供します。 これにより、これらのソリューションで、カスタマイズ可能なアルゴリズムモデルを利用して、メディアのパフォーマンスを評価したり、分析インサイトを提供したりできます。
