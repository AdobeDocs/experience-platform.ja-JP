...
| [!DNL Intelligent Services] | [!UICONTROL Attribution AIを表示 ] | Attribution AI設定およびインサイトへの読み取り専用アクセス |
| [!DNL Intelligent Services] | [!UICONTROL Attribution AIの管理 ] | Attribution AIモデルの読み取り、作成、編集、削除へのアクセス。 |
...
| [!DNL Profile Management] | [!UICONTROL プロファイルの管理] | 複数のソースからデータを取り込み、個々の顧客に対して堅牢なプロファイルを作成し、プロファイル対応のデータをデータレイクおよびリアルタイム顧客プロファイルデータストアに保存します。 |
