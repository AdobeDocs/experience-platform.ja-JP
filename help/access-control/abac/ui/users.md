...
ユーザーの詳細と割り当てられた役割を表示する場合は、「**[!UICONTROL Users]**」タブを選択します。

![ 「[!UICONTROL Users]」タブがハイライト表示された状態で表示されている「ユーザー」ページ ](../../images/flac-ui/flac-users-tab.png)
...
![ タブとユーザープロファイル [!UICONTROL Details] ハイライト表示されたユーザーの詳細ページ ](../../images/flac-ui/flac-users-details.png)

「**[!UICONTROL Roles]**」タブを選択して、ユーザーが割り当てられているロールを表示します。

![ 「[!UICONTROL Roles]」タブと役割がハイライト表示された「役割」ページ ](../../images/flac-ui/flac-users-roles.png)
