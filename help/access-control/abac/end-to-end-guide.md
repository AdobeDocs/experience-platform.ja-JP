...
>[!NOTE]
>
> [!UICONTROL Permissions] オブジェクトレベルのアクセス制御[を使用して、Adobe Journey Optimizerの様々なオブジェクトに](https://experienceleague.adobe.com/ja/docs/journey-optimizer/using/access-control/object-based-access) ワークスペースで作成されたラベル（上記のセグメントラベルなど）を割り当てます。」
