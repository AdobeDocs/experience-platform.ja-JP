---
keywords: Experience Platform；ホーム；人気の高いトピック；GDPR;GDPR;CCPA;CCPA;PDPA;pdpa;LGPD;FAQ；規則；規則；規制；プライバシー；プライバシー；プライバシー；
solution: Experience Platform
title: プライバシー規制に関する FAQ
...
The [Experience Cloudがサポートするプライバシー規制](./overview.md) は、組織の地理的な場所に関係なく、規制の管轄区域内にいる市民の個人データを保存および処理するすべての組織に適用されます。
...
| LGPD（ブラジル） | 15 日 | |
| PDPA（タイ） | 30 日 | 会社がコンプライアンス期間内にデータ主体の要求に応答できない場合、会社は、データ主体に対する書面での応答要求を満たせなかった日から 30 日後に追加の応答を受け取ります。 |
