...
title: 使用可能なサンドボックスAPIエンドポイント
topic-legacy: developer guide
description: 現在のユーザーが使用できるサンドボックスのリストを作成するには、使用可能なサンドボックスエンドポイントにGETリクエストを送信します。
...
現在のユーザーが使用できるサンドボックスのリストを作成するには、使用可能なサンドボックスエンドポイントにGETリクエストを送信します。
