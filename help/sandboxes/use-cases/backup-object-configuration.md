...
![ サンドボックスツールの利点を示す概要 ](../images/use-cases/tooling-overview.png)
...
この時点で、サンドボックスツールのユーザーインターフェイスを使用してサンドボックスをバックアップする準備が整いました。 この手順では、サンドボックス全体のバックアップと、特定のオブジェクトのバックアップの両方をカバーします。
