...
&lbrack; **[!UICONTROL パッケージの共有]** ダイアログで、[ **[!UICONTROL 共有設定]** ] ドロップダウンから共有するパッケージを選択し、[ **[!UICONTROL 確認]**] を選択します。
...
パッケージの可用性の種類を更新するには、&lbrack; [!UICONTROL サンドボックス] **[!UICONTROL パッケージ]** タブに移動します。 次へ、パッケージの横にある省略記号 (`...`) を選択し、ドロップダウン メニューから **[!UICONTROL パブリック パッケージに更新]** を選択します。
...
共有リクエストの現在のステータス表示には、 **[!UICONTROL 共有ステータス]**&#x200B;に移動します。 リクエストの現在のステータスは、&lbrack; **[!UICONTROL 共有ステータス]** 列に表示されます。
