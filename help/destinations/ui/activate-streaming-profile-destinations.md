...
[&#x200B; 同意ポリシーの評価 &#x200B;](/help/data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation) は、現在、3 つのエンタープライズ宛先（Amazon Kinesis、Azure Event Hubs および HTTP API）への書き出しではサポートされていません。
