...
| [!UICONTROL 有効期限] | この宛先への接続認証が期限切れになる日付。 <br>**重要**：この列は現在、[Facebook](../catalog/social/facebook.md)、[LinkedIn](../catalog/social/linkedin.md) および [LinkedIn Matched Audiences](../catalog/social/linkedin-b2b.md) 接続でのみ使用できます。 |
