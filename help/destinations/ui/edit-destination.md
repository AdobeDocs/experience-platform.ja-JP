...
[Google S3](../catalog/cloud-storage/amazon-s3.md)、[Amazon Event Hubs} および ](../catalog/cloud-storage/azure-event-hubs.md)Azure Ads[ の宛先に対して更新できる設定の例を以下に示し ](../catalog/advertising/google-ads-destination.md) す。
