...
### [!BADGE Beta]{type=Informative} アクティベーションフローから複数のオーディエンスを削除 {#bulk-remove}
...
>[!NOTE]
>
オーディエンスの詳細ページの詳細については、 [オーディエンスポータルの概要](../../segmentation/ui/audience-portal.md#segment-details).
