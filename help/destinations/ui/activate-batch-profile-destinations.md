...
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/activate-batch-profile-destinations.html?lang=ja" text="詳しくは、ドキュメントを参照してください"
...
>title="オンデマンドを有効化"
>abstract="以前にスケジュールされたエクスポートの上にファイルの完全なエクスポートを配信するには、このコントロールを選択します。 ファイルの書き出しが直ちにトリガーされます。"
...
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/activate-batch-profile-destinations.html?lang=ja#mandatory-attributes" text="詳しくは、ドキュメントを参照してください"
...
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/activate-batch-profile-destinations.html?lang=ja#deduplication-keys" text="詳しくは、ドキュメントを参照してください"
