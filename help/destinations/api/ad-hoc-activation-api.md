...
このチュートリアルに含まれるすべての API 操作について、付属リファレンスドキュメントが用意されています。[&#x200B; アドホックアクティベーション API リファレンス &#x200B;](https://developer.adobe.com/experience-platform-apis/references/ad-hoc-activation)を参照してください。
