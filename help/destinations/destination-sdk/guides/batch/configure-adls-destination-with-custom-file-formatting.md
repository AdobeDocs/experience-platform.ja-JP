...
title: （ベータ版）カスタムのファイル形式設定オプションとカスタムのファイル名設定を使用して、Azure Data Lake Storage の宛先を設定します。
...
# （ベータ版） [!DNL Azure Data Lake Storage] カスタムのファイルフォーマットオプションとカスタムのファイル名設定を使用した宛先
