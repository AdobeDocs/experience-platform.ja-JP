...
このページでは、Destination SDKを使用して [!DNL Azure Data Lake Storage] カスタムの宛先 [ファイル形式オプション](configure-file-formatting-options.md) そして習慣 [ファイル名設定](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
