---
description: Destination SDKを使用して、カスタムのファイル形式オプションとカスタムのファイル名設定で Azure Data Lake Storage の宛先を設定する方法を説明します。
title: カスタムのファイル形式オプションとカスタムのファイル名設定を使用して、Azure Data Lake Storage の宛先を設定します。
...
# カスタムのファイル形式オプションとカスタムのファイル名設定を使用した、[!DNL Azure Data Lake Storage] の宛先の設定
