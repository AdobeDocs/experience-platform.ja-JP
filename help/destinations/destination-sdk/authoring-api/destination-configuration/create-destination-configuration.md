...
* [OAuth2認証](../../functionality/destination-configuration/oauth2-authorization.md)
...
| `description` | 文字列 | アドビが宛先カードの Experience Platform 宛先カタログで使用する説明を入力します。4 ～ 5 文以下を目指します。宛先の説明を示す![Experience Platform UI イメージ。](../../assets/authoring-api/destination-configuration/destination-description.png "宛先の説明"){width="100" zoomable="yes"} |
...
| `identityNamespaces.externalId.acceptsCustomNamespaces` | ブール | 顧客が[カスタム名前空間](/help/identity-service/features/namespaces.md#create-namespaces)に属する ID を設定中の ID にマッピングできるかどうかを示します。 |
