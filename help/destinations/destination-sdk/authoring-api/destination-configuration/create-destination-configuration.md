...
| `identityNamespaces.externalId.acceptsCustomNamespaces` | ブール値 | 顧客が[カスタム名前空間](/help/identity-service/features/namespaces.md#manage-namespaces)に属する ID を設定中の ID にマッピングできるかどうかを示します。 |
