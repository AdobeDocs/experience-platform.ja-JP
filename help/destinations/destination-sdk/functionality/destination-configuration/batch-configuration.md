...
| `MERGE_POLICY_ID` | [!UICONTROL 結合ポリシー ID] | 書き出されたオーディエンスを生成するために使用される[結合ポリシー](../../../../profile/merge-policies/overview.md)の ID。このマクロは、結合ポリシーに基づいてファイル内の書き出されたオーディエンスをグループ化する際に使用します。このマクロは `segmentGroupingEnabled:true` と併用してください。 | e8591fdb-2873-4b12-b63e-15275b1c1439 |
| `MERGE_POLICY_NAME` | [!UICONTROL 結合ポリシー名] | 書き出されたオーディエンスの生成に使用される[結合ポリシー](../../../../profile/merge-policies/overview.md)の名前。このマクロは、結合ポリシーに基づいてファイル内の書き出されたオーディエンスをグループ化する際に使用します。このマクロは `segmentGroupingEnabled:true` と併用してください。 | カスタム結合ポリシー |
