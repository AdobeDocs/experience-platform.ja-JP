...
description: Nielsen IMA Handler拡張機能は、Adobe Experience Platformの分析先です。 拡張機能について詳しくは、Adobe Exchange の拡張機能のページを参照してください。
...
[!DNL Nielsen IMA Handler]は[!DNL Adobe Experience Platform]のAnalytics拡張機能です。
