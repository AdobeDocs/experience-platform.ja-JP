---
keywords: Google Global Site Tag;gtag;google gtag;google 拡張機能；google gtag 拡張機能；GTAG
...
[!DNL Google Analytics]、[!DNL Google Ads]、および [!DNL Google Marketing Platform] に [!DNL Google's Global Site Tag] または gtag.js を使用してデータを送信します。 製品ごとに複数のアカウントを設定できます。
