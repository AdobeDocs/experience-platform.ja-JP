...
[!DNL TMMData's] Adobe Marketing Cloudの Foundation platform は、社内/外部/オンライン/オフラインデータを含むすべての重要なデータソースにアクセスし、ブレンドして、Adobeや他の分析および BI ツールに直接インポートするツールをマーケティングチームに提供します。
