...
[!DNL LinkedIn Matched Audiences]の宛先に接続するには、[ソーシャルの宛先認証ワークフロー](./workflow.md)を参照してください。

次のビデオでも、[!DNL LinkedIn Matched Audiences]の宛先を設定し、セグメントをアクティブ化する手順を示します。

>[!VIDEO](https://video.tv.adobe.com/v/332599/?quality=12&learn=on&captions=eng)

## [!DNL LinkedIn Matched Audiences] {#activate-segments}に対してセグメントをアクティブ化

[!DNL LinkedIn Matched Audiences]に対してセグメントをアクティブ化する方法については、「[宛先へのデータのアクティブ化](../../ui/activate-destinations.md)」を参照してください。
