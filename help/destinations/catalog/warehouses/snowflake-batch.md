...
* **[!UICONTROL Select Snowflake Region]**: Snowflake インスタンスがプロビジョニングされている地域を選択します。 サポートされるクラウド地域について詳しくは、Snowflake[ ドキュメント ](https://docs.snowflake.com/en/user-guide/intro-regions) を参照してください。
