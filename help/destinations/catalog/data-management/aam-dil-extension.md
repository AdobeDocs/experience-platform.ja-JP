...
[!DNL Audience Manager] DILは、Adobe Experience Platformのデータ管理プラットフォーム(DMP)拡張機能です。拡張機能について詳しくは、Experience Platform Launch ドキュメントの [Audience Manager 拡張機能ページ](../../../tags/extensions/web/audience-manager/overview.md)を参照してください。
...
拡張機能の設定オプションについて詳しくは、 ドキュメントの [Audience Manager 拡張機能のページ](../../../tags/extensions/web/audience-manager/overview.md)を参照してください。[!DNL Experience Launch]
