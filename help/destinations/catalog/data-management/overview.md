---
keywords: dmp の宛先；DIL;audience manager dmp 拡張機能；dmp 拡張機能；データ管理プラットフォーム；データ管理プラットフォームの宛先
...
[!DNL Data Management Platforms] (DMP) を使用すると、広告主、発行者、代理店が独自のオーディエンスプロファイルを構築し、最も価値の高いセグメントを特定して、任意のデジタルチャネルでそれらを使用できます。これにより、真に死角のない消費者プロファイルを作成し、意味のあるオーディエンスを構築しアクティブ化できます。
