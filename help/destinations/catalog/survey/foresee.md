...
[!DNL Foresee] はAdobe Experience Platformの調査拡張です。拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html) の拡張機能のページを参照してください。
