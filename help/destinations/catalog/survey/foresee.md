...
[!DNL Foresee]は[!DNL Adobe Experience Platform]のアンケート拡張機能です。 拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html) の拡張機能のページを参照してください。
