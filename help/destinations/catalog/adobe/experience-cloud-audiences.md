...
Audience Managerのオーディエンスと特性は、[Role-Based Access Controls](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html?lang=ja) （RBAC）の対象です。
