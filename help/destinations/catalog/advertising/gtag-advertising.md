...
>[!IMPORTANT]
>
>ここで説明するGoogle gtag 拡張機能は廃止され、[!DNL Acronym] が開発した [[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag) 拡張機能に置き換えられました。[!DNL Google Global Site Tag (gtag)]拡張機能は、Data Collection UIまたはExperience Platform UIの[[!UICONTROL Tags]](../../../tags/home.md) ワークスペース内にあります。
...
Google gtagは[!DNL Adobe Experience Platform]の広告拡張機能です。 拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html) の拡張機能のページを参照してください。
