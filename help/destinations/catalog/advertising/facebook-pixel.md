...
[!DNL Facebook Pixel] はAdobe Experience Platformの広告の延長です。この拡張機能について詳しくは、[Facebook ピクセルの Web サイト](https://developers.facebook.com/docs/facebook-pixel/)を参照してください。
