...
description: Google Customer Matchを使用すると、オンラインおよびオフラインのデータを使用して、検索、ショッピング、Gmailなど、Googleが所有および運営するプロパティをまたいで顧客にリーチし、リエンゲージメントできます。
...
[[!DNL Google Customer Match]](https://support.google.com/google-ads/answer/6379332?hl=en)を使用すると、オンラインとオフラインのデータを使用して、次のようなGoogleの所有および運営のプロパティで顧客にリーチしてリエンゲージメントできます：[!DNL Search]、[!DNL Shopping]、[!DNL Gmail]。
