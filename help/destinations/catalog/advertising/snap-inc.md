...
* **[!UICONTROL Account ID]**: オーディエンスのインポート先の広告アカウントに関連付けられている広告アカウント ID。 見つける方法の詳細については、[Snapchat ビジネスヘルプセンターのこのドキュメント &#x200B;](https://businesshelp.snapchat.com/s/article/biz-acct-id?language=en_US) を参照してください。
