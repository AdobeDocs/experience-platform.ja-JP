---
keywords: Flashtalking OneTag 拡張機能；Flashtalking OneTag 拡張機能；Flashtalking OneTag の宛先；Flashtalking OneTag;flashtalking OneTag
...
[!DNL Flashtalking OneTag] タグ拡張機能を使用すると、サイトのアクションを簡単に属性化して、表示、ビデオ、モバイルの広告アクティビティを表示できます。 タグを使用して、Web プロパティに [!DNL Flashtalking OneTag] をデプロイします。
