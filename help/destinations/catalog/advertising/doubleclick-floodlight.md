...
[!DNL DoubleClick Floodlight] （ベータ版）は、Adobe Experience Platformの広告の拡張機能です。拡張機能の機能について詳しくは、[DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=ja)の[!DNL Google]サポートドキュメントを参照してください。
