...
description: LinkedIn Insight タグ拡張機能は、Adobe Experience Platformの広告配信先です。 拡張機能について詳しくは、Adobe Exchange の拡張機能のページを参照してください。
...
コンバージョンの追跡、リターゲティング、およびweb サイトのデモグラフィック機能を使用するには、[!DNL LinkedIn Insight Tag]をインストールします。

[!DNL LinkedIn Insight Tag]は[!DNL Adobe Experience Platform]の広告拡張機能です。 この拡張機能について詳しくは、「[LinkedIn Insight タグ](https://business.linkedin.com/marketing-solutions/insight-tag)」を参照してください。
