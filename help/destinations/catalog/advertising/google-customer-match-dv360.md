...
>[!NOTE]
>
>**Google Customer Match + DV360 コネクタの限定提供**<br> このGoogleとの統合に関する成熟度のライフサイクル全体を通して行っているので、より広い普及を実現する前に修正する必要がある実装の弱点を示すデータを確認しています。 このような懸念を踏まえ、Adobeでは、この宛先を表示するお客様の数を制限しています。 アドビは、製品エクスペリエンスを向上させるために、Googleと積極的に話し合っています。 残念ながら、高品質で信頼性の高いエクスペリエンスをお客様に提供することが、私たちの責任あるアプローチであると考えています。</br>
...
>[!NOTE]
>
>Adobeは、Google パートナーアカウント ID を `6219889373` から `4641108541` に更新しました。
>
>**Google アカウントが現在、古いAdobe パートナーアカウント ID （`6219889373`）にリンクされている場合は、次の手順に従います。**
>
...
>
>Google アカウントが既に新しいAdobe パートナーアカウント ID （`4641108541`）にリンクされている場合は、何もする必要はありません。
