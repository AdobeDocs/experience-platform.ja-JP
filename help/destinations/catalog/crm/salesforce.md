...
description: Salesforce CRMの宛先を使用すると、アカウントデータを書き出し、ビジネスニーズに合わせてSalesforce CRM内でアクティベートできます。
...
1. 最後に、Salesforce web サイトにログインし、オーディエンスのプロファイルが更新されているかどうかを検証します。
