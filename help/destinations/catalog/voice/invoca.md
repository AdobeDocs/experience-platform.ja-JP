...
description: Invoca Tags 拡張機能は、Adobe Experience Platformの顧客の宛先の音声です。 拡張機能について詳しくは、Adobe Exchange の拡張機能のページを参照してください。
...
[!DNL Invoca] は、通話データと音声の洞察をデジタルカスタマージャーニーに提供します。[!DNL Invoca’s] 通話インテリジェンスプラットフォームを使用すると、マーケターは、最終的に、通話の結果を測定し、オフラインのコンバージョンをデジタル支出に結び付ける分析を行うことができます。
...
[!DNL Invoca Tags] 拡張機能をインストールするには：
