...
[!DNL Marketo Munchkin] はAdobe Experience Platformの電子メール拡張子です。拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html) の拡張機能のページを参照してください。
