...
[!DNL PebblePost] は、Adobe Experience Platformの電子メール拡張です。PebblePost の詳細については、[ 統合ブログの投稿 ](https://blog.adobe.com/en/publish/2017/11/16/pebblepost-builds-integration-launch-adobe.html#gs.7lejiq) を参照してください。
