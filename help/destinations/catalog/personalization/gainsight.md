---
keywords: 予測子；予測子の拡張機能；予測先
title: Gainsight 拡張機能
description: Gainsight拡張機能は、Adobe Experience Platformにおけるパーソナライゼーションの宛先です。 拡張機能について詳しくは、Adobe Exchange の拡張機能のページを参照してください。
...
[!DNL Gainsight]は、ユーザーの行動を深く理解し、製品の採用を促進し、ユーザーのフィードバックを収集するためのツールを製品オーナーに提供します。

[!DNL Gainsight]は[!DNL Adobe Experience Platform]のパーソナライゼーション拡張機能です。 拡張機能について詳しくは、[Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html) の拡張機能のページを参照してください。
