...
[!DNL Gainsight] は、Adobe Experience Platformのパーソナライゼーション拡張です。拡張機能について詳しくは、[Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html) の拡張機能のページを参照してください。
