...
| リリース月 | 更新タイプ | 説明 |
|---|---|---|
| 2024年1月 | 機能とドキュメントの更新。 | デフォルトの実稼動サンドボックスと、その他のデフォルト以外のサンドボックス用に、オーディエンスおよびプロファイル属性をAdobe Target接続に共有できるようになりました。 |
