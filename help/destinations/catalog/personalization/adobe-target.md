...
Adobe TargetはAdobe Experience Platformのパーソナライゼーション拡張です。 拡張機能について詳しくは、[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100162.html) の拡張機能のページを参照してください。
