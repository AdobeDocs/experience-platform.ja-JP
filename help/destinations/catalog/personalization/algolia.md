...
>[!IMPORTANT]
>
>[!DNL Algolia] の宛先コネクタとドキュメントページは、Algolia Integration Services チームによって作成および管理されます。 お問い合わせや更新のリクエストについては、[adobe-algolia-solutions@algolia.com](adobe-algolia-solutions@algolia.com) までお問い合わせください。
