---
title: Mailchimp タグ
description: Mailchimp タグの宛先を使用してアカウントデータをエクスポートし、Mailchimp内でアクティベートして連絡先とエンゲージします。
...
1. [[!DNL Mailchimp]](https://login.mailchimp.com/) アカウントに移動します。 次に、**[!DNL Audience]** > **[!DNL All Contacts]** ページに移動し、オーディエンスの連絡先が追加され、オーディエンス内の連絡先がオーディエンス名で更新されたかどうかを確認します。
