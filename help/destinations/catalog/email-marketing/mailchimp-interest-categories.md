...
**API キー**&#x200B;をお持ちでない場合は、アカウントにログインし、[[!DNL Mailchimp] API キーの生成](https://mailchimp.com/developer/marketing/guides/quick-start/#generate-your-api-key) ドキュメントを参照して作成してください。
