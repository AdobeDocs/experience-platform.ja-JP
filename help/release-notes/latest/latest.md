...
様々なユースケースプレイブックを実験し探索するために、インスピレーションを与えるサンドボックスにアクセスして設定する方法については、を参照してください。 [正しいプレイブックを見つける](/help/use-case-playbooks/playbooks/discover.md) ドキュメント。
