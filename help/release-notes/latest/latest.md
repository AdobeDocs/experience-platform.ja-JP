...
- [Adobe Experience Platform リリースノート](#adobe-experience-platform-release-notes)
   - [ダッシュボード {#dashboards}](#dashboards-dashboards)
      - [アカウントプロファイルダッシュボード](#account-profiles-dashboards)
      - [プロファイルダッシュボード](#profile-dashboards)
      - [宛先ダッシュボード](#destinations-dashboards)
   ...
   - [Real-time Customer Data Platform B2B エディション {#b2b}](#real-time-customer-data-platform-b2b-edition-b2b)
   - [リアルタイム顧客プロファイル {#profile}](#real-time-customer-profile-profile)
...
セグメント定義で関連アカウントを使用する手順については、 [Real-time Customer Data Platform B2B Edition のセグメント化の使用例](../../rtcdp/segmentation/b2b.md#related-accounts).
