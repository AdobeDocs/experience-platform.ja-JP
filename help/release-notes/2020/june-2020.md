---
title: Adobe Experience Platformリリースノート（2020 年 6 月）
description: Adobe Experience Platformの 2020 年 6 月のリリースノート。
...
詳しくは、 [!DNL Real-time Machine Learning] アルファ、 [リアルタイム機械学習の概要](../../data-science-workspace/real-time-machine-learning/home.md).
