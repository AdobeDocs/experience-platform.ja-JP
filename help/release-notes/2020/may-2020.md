...
使用するノートブックとレシピの移行に関する詳細 [!DNL Spark] 2.4、 [ノートブックデータアクセスガイド](../../data-science-workspace/jupyterlab/access-notebook-data.md). Data Science Workspace の一般情報について詳しくは、 [概要ドキュメント](../../data-science-workspace/home.md).
