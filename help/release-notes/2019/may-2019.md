...
| [!DNL Schema Library] | [!DNL Schema Library] には、個々の組織で定義されたリソースや、アプリケーションが [!DNL Schema Registry] と統合されているAdobe、[!DNL Experience Platform] パートナー、ベンダーのすべてのユーザーが使用できるリソースなど、すべての [!DNL Experience Platform] リソースが含まれています。 |
