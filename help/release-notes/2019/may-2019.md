...
| [!DNL Schema Library] | この [!DNL Schema Library] すべてを含む [!DNL Schema Registry] リソース ( 個々の IMS 組織で定義されたリソースや、Adobeがすべてのユーザーに提供するリソースを含む ) [!DNL Experience Platform] パートナー、およびアプリケーションを統合するベンダー [!DNL Experience Platform]. |
