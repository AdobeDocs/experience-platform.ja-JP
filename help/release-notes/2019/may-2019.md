...
Adobe Experience Platform を使用すると、会社は複数のエンタープライズシステムからデータを統合し、マーケティング担当者が顧客をより良く識別、理解し、惹きつけることができるようになります。[!DNL Experience Platform] (DULE)を含むエンド・ツー・エンドのデータ・ガバナンス・インフラストラクチャが含まれ [!DNL Data Usage Labeling and Enforcement] 、システム間でデータを適切に使用し、システム間で共有する場合 [!DNL Platform] にデータを適切に使用できます。
