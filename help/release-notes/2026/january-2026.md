...
| オーディエンスの検証 | Experience Platformには、オーディエンスの正確性、安定性、拡張性を確保するための組み込みの検証機能が備わっています。 オーディエンス定義の作成中、これらのチェックはリアルタイムで自動的に実行されます。 詳しくは、[&#x200B; オーディエンス検証の概要 &#x200B;](/help/segmentation/validation.md) を参照してください。 |
