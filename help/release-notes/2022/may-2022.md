...
>[!IMPORTANT]
>
>現在、データハイジーン機能は、Adobe Shield for Healthcare のアドオン機能を購入した組織でのみ利用できます。

**新機能**

| 機能 | 説明 |
| --- | --- |
| データセットの有効期間（TTL） | Platform データセット用に[ TTL のスケジュールを設定](../../hygiene/ui/ttl.md)します。 |

{style=&quot;table-layout:auto&quot;}

Platform の監査ログについて詳しくは、[データハイジーンの概要](../../hygiene/home.md)を参照してください。
...
| 機能 | 説明 |
| ------- | ----------- |
| 同意ポリシーの適用（制限付きで使用可能） | 組織が Adobe Shield for Healthcare アドオン機能を購入している場合は、[同意ポリシーを作成](../../data-governance/policies/user-guide.md#consent-policy)し、自動的に[セグメントパーティシペーションにおける顧客の同意および好みを適用](../../data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation)します。 |
