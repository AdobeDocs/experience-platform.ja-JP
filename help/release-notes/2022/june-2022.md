...
| [Google データレイヤータグ拡張機能](../../tags/extensions/web/google-data-layer/overview.md) | Google データレイヤー拡張機能を使用すると、タグ実装で Google データレイヤーを使用できます。 |
...
| [Mailchimp イベント転送拡張機能](../../tags/extensions/web/mailchimp/overview.md) | Mailchimp イベント転送拡張機能は、Mailchimp マーケティングキャンペーン、ジャーニー、トランザクション用のメールをトリガーできる Mailchimp Marketing API にイベントを送信します。 |
...
| グローバルスキーマ | （複数） | Real-Time CDP Insights の宛先指標で新しいグローバルスキーマを使用できます。 詳しくは、次の[プルリクエスト](https://github.com/adobe/xdm/pull/1560)を参照してください。 |
