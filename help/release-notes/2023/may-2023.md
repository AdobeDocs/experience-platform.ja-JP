...
| 宛先 | 説明 |
| ----------- | ----------- |
| **[[!UICONTROL Mailchimp Interest Categories]](../../destinations/catalog/email-marketing/mailchimp-interest-categories.md)** | **[!UICONTROL Mailchimp]**&#x200B;は、メーリングリストとメールマーケティングキャンペーンを使用して連絡先（顧客、顧客、その他の興味のある関係者）を管理し、会話するために企業が使用する人気のあるマーケティングオートメーションプラットフォームおよびメールマーケティングサービスです。 このコネクタを使用すると、興味や好みに基づいて連絡先を並べ替えることができます。 |
...
| ベータ版のクラウドストレージの宛先への書き出しにマニフェストファイルを含める | シックスクラウドストレージのベータ版の宛先 – [&#x200B; （Beta） Amazon S3](/help/destinations/catalog/cloud-storage/amazon-s3.md)、[&#x200B; （Beta） Azure Blob](/help/destinations/catalog/cloud-storage/azure-blob.md)、[&#x200B; （Beta） Azure Data Lake Storage Gen2](/help/destinations/catalog/cloud-storage/adls-gen2.md)、[&#x200B; （Beta） Data Landing Zone](/help/destinations/catalog/cloud-storage/data-landing-zone.md)、[&#x200B; （Beta） Google Cloud Storage](/help/destinations/catalog/cloud-storage/google-cloud-storage.md)、[&#x200B; （Beta） SFTP](/help/destinations/catalog/cloud-storage/sftp.md)）にデータを書き出す際に、書き出し場所、書き出しサイズなどに関するマニフェスト JSON ファイルを含できるようになりました。 <br><br>詳細については、上記のリンク先ページの&#x200B;**[!UICONTROL Destination details]** セクションを参照してください。 |
...
| フィールドグループ | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1721/files) | メタデータタグの`partnerProspect` オプションが[!UICONTROL XDM Individual Prospect Profile] クラスに追加されました。 |
| データタイプ | （複数） | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1716/files) データタイプに複数のフィールドが追加されました。 |
| データタイプ | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1716/files) | リダイレクトが発生したかどうかを示す新しいフィールドを追加しました。 |
| フィールドグループ | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1716/files) | メディアレポートに関連する新しいフィールドを追加しました。 |
...
| 機能 | 説明 |
| --- | --- |
| Adobe Experience Cloud アプリケーション[!BADGE ベータ版]{type=Informative}内でのパートナー ID のサポート | パートナー ID を ID サービスで使用できるようになりました。パートナー ID は、人物を表すためにデータパートナーが使用する識別子です。Real-time Customer Data Platform では、パートナー ID は主に、オーディエンスのアクティベーションの拡張とデータエンリッチメントに使用されます。パートナー ID は、ID グラフには保存されません。詳しくは、[ID タイプ](../../identity-service/features/namespaces.md#identity-types)に関するドキュメントを参照してください。 |
...
| ドラフトモード用の UI サポート | ユーザーインターフェイスを介して、ソースワークフロー中に一時停止して進行状況を保存できるようになりました。ワークフローのデータフローの詳細、マッピング、スケジュールの各ステップで&#x200B;**[!UICONTROL Save as draft]**&#x200B;を選択し、後で完了するためにデータフローをドラフトとして保存できます。 詳しくは、[UI でのデータフローのドラフトとして保存](../../sources/tutorials/ui/draft.md)を参照してください。 |
