...
- [Adobe Experience Platform リリースノート](#adobe-experience-platform-release-notes)
   - [カタログサービス {#catalog-service}](#catalog-service-catalog-service)
...
- オーディエンスを [JSON または Parquet ファイル](/help/destinations/ui/activate-batch-profile-destinations.md#supported-file-formats-export)に追加する必要があります。
