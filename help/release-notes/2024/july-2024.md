...
- [!BADGE &#x200B; 限定提供 &#x200B;]{type=Informative}[Federated Audience コンポジション &#x200B;](#federated-audience-composition)
...
| タイプ | 機能 | 説明 |
| --- | --- | --- |
| Web SDK | 提案インタラクションを自動的に追跡 | Web SDKの `autoCollectPropositionInteractions` プロパティを使用して、Web SDKが提案インタラクションを自動的に収集する必要があるかどうかを判断できるようになりました。 詳しくは、[`autoCollectPropositionInteractions`](/help/collection/js/commands/configure/autocollectpropositioninteractions.md) のドキュメントを参照してください。 |
...
| 更新されたドキュメント | 説明 |
| --- | --- |
| [[!DNL Snowflake]](../../sources/connectors/databases/snowflake.md) の拡張認証ガイド | 認証用の [!DNL Snowflake] アカウント識別子 [&#x200B; と &#x200B;](../../sources/connectors/databases/snowflake.md#retrieve-your-account-identifier) 秘密鍵 [&#x200B; を取得する方法については、拡張認証ガイドを &#x200B;](../../sources/connectors/databases/snowflake.md#retrieve-your-private-key) 照してください。 さらに、[&#x200B; ウェアハウスとロールの設定を検証 &#x200B;](../../sources/connectors/databases/snowflake.md#verify-configurations) する手順については、拡張された認証ガイドを参照してください。 |
