...
| 機能 | 説明 |
| --- | --- |
| Experience Platform の AI アシスタント | Experience Platformで AI アシスタントを使用できるようになりました。 AI アシスタントは、Experience Platform、Real-Time Customer Data Platform、Adobe Journey Optimizer、Customer Journey Analyticsをサポートします。<br> ![Experience Platform の AI アシスタント。](../2024/assets/june/ai-assistant-full.png "Experience Platform の AI アシスタント。"){width="100" zoomable="yes"} <br> この機能の詳細については、[AI アシスタント UI ガイド ](../../ai-assistant/ui-guide.md) を参照してください。 |
