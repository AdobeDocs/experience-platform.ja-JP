...
>[!IMPORTANT]
>
>現在データハイジーンを利用できるのは、**Adobe Healthcare Shield** または **Adobe Privacy &amp; Security Shield** を購入した組織のみです。これらの機能は、近い将来に一般リリースが予定されています。 今後のリリースの詳細については、Adobe サービス担当者にお問い合わせください。 ただし、すぐに実行できます [でデータセットを削除する [!UICONTROL データセット] UI](../catalog/datasets/user-guide.md#delete).
