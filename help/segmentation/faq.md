...
| 都道府県 | 定義 | オーディエンスポータルに表示しますか？ | 宛先に表示しますか？ | セグメント化の制限に影響しますか？ | ファイルベースのオーディエンスへの影響 | オーディエンスの評価への影響 | 他のオーディエンス内で使用できますか？ |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| アクティブ | このステータスは、 **非推奨** とは、に置き換えられます。 **公開済み** ステータス。 | なし | なし | なし | なし | なし | なし |
