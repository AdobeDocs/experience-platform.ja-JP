...
>[!NOTE]
>
>ストリーミングセグメント化を機能させるには、スケジュールされたセグメント化を組織で有効にする必要があります。 スケジュールされたセグメント化を有効にする方法について詳しくは、以下を参照してください。 [オーディエンスポータルの概要](./audience-portal.md#scheduled-segmentation).
...
>
>これらのステータスの詳細については、 [オーディエンスポータルの概要](./audience-portal.md#customize).
