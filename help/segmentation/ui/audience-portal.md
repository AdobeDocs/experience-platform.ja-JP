...
>[!IMPORTANT]
>
柔軟なオーディエンス評価を行うためにオーディエンスを選択する場合は、次の条件が適用されます。
>
- 柔軟なオーディエンス評価 **1 日に 2 回** のみ使用できます。 この制限は、午前 0 時（UTC）にリセットされます。
- 柔軟なオーディエンス評価は、1 年に **最大 50 回** 実行されます。
...
![ 柔軟なオーディエンス評価を使用して評価できるオーディエンスが表示されます。](../images/ui/audience-portal/evaluate-audiences-modal.png)
...
![2 種類を表示するポップオーバー of 作成可能なオーディエンス。](../images/ui/audience-portal/create-audience-type.png)
