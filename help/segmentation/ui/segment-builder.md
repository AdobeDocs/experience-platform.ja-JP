...
>[!NOTE]
>
>Platform 内で作成されたオーディエンスの場合、**同じ** 結合ポリシーを持つオーディエンスのみが表示されます。
...
**[!UICONTROL 推定プロファイル]** は、（サンプルジョブ **に基づいたプロファイルの** 概算 **数を示し** す。 新しいルールまたは条件を追加して「**[!UICONTROL 予測を更新]**」を選択すると、この値の更新バージョンを確認できます。 情報バブルを選択すると、エラーしきい値と最新のサンプルジョブ時間が表示されます。
