...
このチュートリアルに従って、オーディエンスセグメントに関連付けられたデータ使用ラベルを調べ、特定のマーケティング操作に対するポリシー違反がないかテストしました。 Experience Platformのデータガバナンスの詳細については、「 [データガバナンスの概要](../../data-governance/home.md)」を参照してください。
