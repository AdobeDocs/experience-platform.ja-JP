...
| 値の分析 | AI アシスタントを使用して、最も使用されているデータオブジェクトを特定し、パフォーマンスインジケーターを評価したり、最も価値のあるデータオブジェクトを見つけたりします。 | <ul><li>「Luma：メールオーディエンス」のセグメント定義にはプロファイルがいくつありますか？</li><li>オーディエンスがExperience Cloud Audiences の宛先に対してアクティブ化されたのはいつですか？</li></ul> |
| 検索 | AI アシスタントを使用して、オーディエンス、データセット、宛先、スキーマ、ソースなど、サポートされるExperience Platform オブジェクトを検索します。 | <ul><li>前四半期に作成した名前に「Luma」が含まれているオーディエンスをリストします。</li><li>「Luma：カスタムアクション」 XDM スキーマには何の属性がありますか。</li></ul> |
