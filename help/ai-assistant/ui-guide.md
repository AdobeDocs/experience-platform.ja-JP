...
![Experience Platformのホームページ（AI Assistant アイコンが選択され、AI Assistant インターフェイスが開いている状態）](./images/ai-assistant.png)
...
![オペレーショナルインサイトに関するフォローアップの質問。](./images/usage-data-question.png)
...
![AI アシスタントが回答を計算する方法を示す、セグメント定義に関する質問を続けます。](./images/answer-explained.png)
...
![マルチターンの例](./images/multi-turn.png)
