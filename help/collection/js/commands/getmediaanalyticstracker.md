...
## Web SDK タグ拡張機能を使用した Media Analytics トラッカーの取得

このコマンドに相当する web SDK タグ拡張機能は、[**[!UICONTROL Get Media Analytics tracker]**](/help/tags/extensions/client/web-sdk/actions/get-media-analytics-tracker.md) のアクションです。
