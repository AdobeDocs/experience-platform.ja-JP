...
さらに、Web SDKは、[Adobe Target](/help/destinations/catalog/personalization/adobe-target-connection.md) や [&#x200B; カスタムパーソナライゼーション接続 &#x200B;](/help/destinations/catalog/personalization/custom-personalization.md) などのAdobe Experience Platform パーソナライゼーション宛先を通じて、同じページおよび次のページのパーソナライゼーション機能を強化します。 同じページと次のページのパーソナライゼーションに対応するExperience Platformの設定方法については、[&#x200B; 専用ガイド &#x200B;](/help/destinations/ui/activate-edge-personalization-destinations.md) を参照してください。
