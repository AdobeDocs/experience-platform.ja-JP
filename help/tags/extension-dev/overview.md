...
Adobe Experience Platformの主な目標の1つは、コアエンジニアリングチーム以外のエンジニアがタグを使用して追加機能を公開できるオープンなエコシステムを構築することです。 これは、タグ拡張を使用しておこないます。 拡張機能がユーザーによってタグプロパティにインストールされると、そのプロパティのすべてのユーザーがその拡張機能を使用できるようになります。
