...
## Experience Platformとデータ収集のユーザー権限の設定
...
会社にタグへのアクセスがプロビジョニングされ、ユーザーが上記のように設定されると、[Adobe Experience Cloudのダッシュボード ](https://experience.adobe.com/) からデータ収集 UI およびExperience Platform UI にアクセスできるようになります。 上記の手順を完了してもまだ UI にアクセスできない場合は、Adobe アカウントチームまたはカスタマーケアにお問い合わせください。
