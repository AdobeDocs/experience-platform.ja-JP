...
他に質問がある場合は、アドビコミュニティの [https://adobe.com/go/launchme](https://adobe.com/go/launchme) にある主なタグのページでお問い合わせください。

タグは、よりオープンで、より統合され、常に顧客の成功のために尽力するという、プラットフォームが目指すものの一つです。
