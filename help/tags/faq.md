...
他に質問がある場合は、Experience Leagueの [Adobe Experience Platform Data Collection コミュニティページ &#x200B;](https://adobe.com/go/launchme) で質問するか、[&#x200B; コミュニティ Slack Workspace](https://docs.google.com/forms/d/e/1FAIpQLScq1m63YkDrRpvPLhzUqtfoleWiDDTTXZsSivIXRfFdlSMzpQ/viewform) に参加して、開発者や技術実装に関するトピックを検索できます。
