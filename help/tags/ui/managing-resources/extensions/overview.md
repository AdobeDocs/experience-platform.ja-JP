...
拡張機能カタログを使用して、独立系ソフトウェアベンダーによって構築および管理されるマーケティングテクノロジーと広告テクノロジー、およびAdobeソリューションの拡張機能を参照、設定、デプロイします。
...
Adobeが所有する拡張機能について詳しくは、「 [拡張機能のリファレンス](../../../extensions/web/overview.md) 」を参照してください。
...
それぞれの設定可能な拡張機能には、固有のオプションがあります。各拡張機能で使用できるオプションについて詳しくは、「[Adobeリファレンス](../../../extensions/web/overview.md)」を参照してください。
