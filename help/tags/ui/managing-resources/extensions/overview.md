...
デフォルトでは、アドビは共通の統合をサポートする拡張機能を提供します。拡張機能は、カスタム設定で変更できます。設定は拡張機能を通じて提供されます。設定を作成するには、拡張機能カードを選択してから「**[!UICONTROL 新しい設定を追加]**」をクリックします。

## 拡張機能カタログ

拡張機能カタログを使用して、独立ソフトウェアベンダーによって構築および管理されるマーケティングテクノロジーや広告テクノロジー、アドビソリューションの拡張機能を参照、設定、およびデプロイします。
...
それぞれの設定可能な拡張機能には、固有のオプションがあります。各アドビ拡張機能で使用できるオプションについての情報は、[拡張機能リファレンス](../../../extensions/web/overview.md)を参照してください。
