...
1. 条件を選択 **[!UICONTROL 追加]** アイコンをクリックして、論理タイプ、拡張機能、および条件タイプを選択し、条件の設定を指定します。 次に、「**[!UICONTROL 変更を保持]**」を選択します。
...
1. アクションを選択 **[!UICONTROL 追加]** アイコンをクリックして、拡張機能と、その拡張機能で使用可能ないずれかのアクションタイプを選択し、アクションの設定を指定してから選択します。 **[!UICONTROL 変更を保持]**.
