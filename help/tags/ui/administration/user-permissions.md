...
UI でタグプロパティを作成すると製品で使用できるようになります。これにより、同じAdmin Consoleプロファイル内の、特定のプロパティ権限を持つプロパティをグループ化できます。
...
| マーケター | 拡張機能をインストールし、既存のプロパティに新しいタグを設定できるけれど、ステージング環境や実稼働環境に公開することはできない。 | 自動インクルード | <ul><li>開発</li><li>拡張機能の管理</li></ul> | <ul><li>プロパティの管理</li></ul> |
