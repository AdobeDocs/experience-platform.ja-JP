...
MA 拡張機能は、`get-instance` および `media-heartbeat` 共有モジュールを他の拡張機能に公開します。（共有モジュールについて詳しくは、[共有モジュールのドキュメント](https://developer.adobelaunch.com/extensions/shared_modules/)/を参照してください。）
