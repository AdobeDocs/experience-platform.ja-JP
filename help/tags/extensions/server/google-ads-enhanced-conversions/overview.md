...
![この [!UICONTROL Google Global Site Tag (gtag)] 以下の下で選択されている拡張 [!UICONTROL 拡張機能] 表示 [!UICONTROL データ収集] UI](../../../images/extensions/server/google-ads-enhanced-conversions/install-gtag-extension.png)
...
![この [!UICONTROL イベントの送信] ルール編集ワークフローの「アクション設定」ビュー内で選択されているアクションタイプ。](../../../images/extensions/server/google-ads-enhanced-conversions/select-client-action.png)
...
![この [!UICONTROL Google Ads 拡張コンバージョン] 以下の下で選択されている拡張 [!UICONTROL 拡張機能] 表示 [!UICONTROL データ収集] UI](../../../images/extensions/server/google-ads-enhanced-conversions/install-enhanced-conversions.png)
...
1. **[!UICONTROL トークンデータ要素にアクセス]**:データ要素アイコン (![データ要素アイコン](../../../images/extensions/server/google-ads-enhanced-conversions/data-element-icon.png)) をクリックし、目的のGoogle OAuth 2 secret データ要素を選択します。 [前の手順で設定済み](#create-secret-data-element) を選択します。
...
![この [!UICONTROL 変換を送信] ルール編集ワークフローの「アクション設定」ビュー内で選択されているアクションタイプ。](../../../images/extensions/server/google-ads-enhanced-conversions/select-server-action.png)
...
>
>![この [!UICONTROL Normalize &amp; Hash] 有効にする [!UICONTROL 電子メール] 内の入力 [!UICONTROL 変換を送信] アクション設定フォーム。](../../../images/extensions/server/google-ads-enhanced-conversions/hash-user-id-values.png)
