...
* **ビジュアルパーソナライゼーションの決定をレンダリング：** 有効にすると、ページ上のパーソナライズされたコンテンツをレンダリングできるチェックボックス。 詳しくは、[DOM アクションの自動レンダリング ](/help/collection/use-cases/personalization/render-auto-pers-content.md) を参照してください。
