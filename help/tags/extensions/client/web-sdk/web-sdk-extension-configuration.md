...
このセクションでは、パーソナライズされたコンテンツを読み込む際に、ページの特定の部分を非表示にする方法を設定できます。 これにより、訪問者には、パーソナライズされたページのみが表示されます。
...
### 事前非表示のスタイル {#prehiding-style}

事前に非表示にするスタイルエディターを使用すると、カスタム CSS ルールを定義して、ページの特定のセクションを非表示にすることができます。 ページが読み込まれると、Web SDK はこのスタイルを使用して、パーソナライズする必要があるセクションを非表示にし、パーソナライズ機能を取得して、パーソナライズされたページセクションの非表示を解除します。 これにより、パーソナライゼーションの取得プロセスを表示することなく、訪問者には既にパーソナライズされたページが表示されます。

### スニペットを事前に非表示にする {#prehiding-snippet}

事前非表示のスニペットは、Web SDK ライブラリが非同期で読み込まれる場合に役立ちます。 この場合、ちらつきを防ぐために、Web SDK ライブラリを読み込む前にコンテンツを非表示にすることをお勧めします。

事前非表示スニペットを使用するには、コピーして `<head>` 要素を含める必要があります。

>[!IMPORTANT]
>
事前非表示スニペットを使用する場合、Adobeは同じを使用することをお勧めします [!DNL CSS] ルールは、 [事前非表示スタイル](#prehiding-style).
