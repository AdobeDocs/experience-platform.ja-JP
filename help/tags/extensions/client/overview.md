---
title: タグ拡張機能リファレンス
description: Adobe Experience Platformでタグ拡張機能のドキュメントを検索します。
...
以下は、クライアントサイドのタグ拡張機能に関するドキュメントのリストです。 使用可能なサーバーサイド拡張機能のリストについては、代わりに [ イベント転送拡張機能リファレンス ](../server/overview.md) を参照してください。
...
* [Activity Map カスタマイズ機能 ](https://exchange.adobe.com/apps/ec/101531)*
...
* [Adobe AnalyticsおよびAdobe Target](https://exchange.adobe.com/apps/ec/105363/*6sense-for-analytics-and-target)*
* [Adobe AnalyticsおよびMicrosoft Dynamics](https://exchange.adobe.com/apps/ec/102966)*
* [Adobe AnalyticsおよびSalesforce](https://exchange.adobe.com/apps/ec/101530)*
* [Adobe Analytics製品文字列](./product-string/overview.md)
...
* [Adobe Experience Manager アセットインサイト](./asset-insights/overview.md)
...
* [Adobe レポートスイートの選択 ](https://exchange.adobe.com/apps/ec/100640)*
...
* [Channel Source識別子 ](https://exchange.adobe.com/apps/ec/101412)*
...
* [Usercentrics CMP v2 による Cookie 同意管理 ](https://exchange.adobe.com/apps/ec/*107037)*
* [コア](./core/overview.md)
* [ カスタムデバッグロガー ](https://exchange.adobe.com/apps/ec/104698)*
* [ お客様の認識 ](https://exchange.adobe.com/apps/ec/100688)*
* [DEA （Data Element Assistant） ](https://exchange.adobe.com/apps/ec/101413)*
* [ データ レイヤ マネージャ ](https://exchange.adobe.com/apps/ec/101462)*
...
* [Google データレイヤー](./google-data-layer/overview.md)
...
* [ キックファイア ](https://exchange.adobe.com/apps/ec/101621)*
...
* [マスター プロパティ マネージャー ](https://exchange.adobe.com/apps/ec/102992)*
* [ モニタ ](https://exchange.adobe.com/apps/ec/106544)*
* [Nielsen Digital SDK](https://exchange.adobe.com/apps/ec/101361)*
* [Cookie の OneTrust 同意管理 ](https://exchange.adobe.com/apps/ec/100340)*
