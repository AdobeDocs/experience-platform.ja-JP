...
[Adobe Media Analytics (3.x SDK) for Audio and Video 拡張機能](./overview.md)により、コア Media Analytics 3.x JavaScript ライブラリが追加されます。このライブラリは、タグが有効になっているサイトまたはプロジェクトにメディアを追跡する機能を提供します。
