...
## バージョン2.15.0 - 2023 年 1 月 25 日

* データストリームにアクセスできないユーザーが、拡張機能の設定を編集できない問題を修正しました。
* でのサーフェスのサポートを追加しました。 `sendEvent` アクション。

Adobe Experience Platform Web SDK のバージョン2.14.0が含まれています。


## バージョン2.14.1 - 2022 年 10 月 13 日

* Web SDK がExperience CloudID サービスからの ID を受け入れない問題を修正しました。

Adobe Experience Platform Web SDK ライブラリのバージョン2.13.1が含まれています。
...
Adobe Experience Platform Web SDK ライブラリのバージョン2.10.1が含まれています。

## バージョン2.11.1 - 2022 年 4 月 23 日

* バージョン2.11.0の configure コマンドエラーを修正しました。
