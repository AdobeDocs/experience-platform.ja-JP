...
>[!NOTE]
>
>SPAでVisual Experience Composerを使用するには、 [Adobe TargetVEC Helper Chrome Extension](https://chrome.google.com/webstore/detail/adobe-target-vec-helper/ggjpideecfnbipkacplkhhaflkdjagak)をインストールする必要があります。
