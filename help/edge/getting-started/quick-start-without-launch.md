...
このガイドでは、Adobe Experience PlatformWeb SDKの様々な設定方法を順を追って説明します。 この機能を使用するには、許可リスト上にいる必要があります。 待機中のリストに移動したい場合は、CSMに連絡してください。
...
- Adobe Experience PlatformデータPlatformの権利を付与されます。  Platformを購入していない場合は、Data Services Foundationをご利用いただけるよう、SDKをご利用いただく際に追加料金はかかりません。
