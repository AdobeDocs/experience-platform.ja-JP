...
# Adobe Experience PlatformWeb SDK JavaScriptクイック開始ガイド

このガイドでは、Adobe Experience PlatformWeb SDKの様々な設定方法を順を追って説明します。 この機能を使用するには、許可リスト上にいる必要があります。 待機中のリストに移動したい場合は、認定ソフトウェアマネージャ(CSM)に連絡してください。
