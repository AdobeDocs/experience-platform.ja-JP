...
>[!IMPORTANT]
>
>ガバナンスポリシーは、組織内の特定のExperience Platform ユーザーがアクセスできる特定のデータ属性を決定するアクセス制御ポリシーと混同しないでください。 アクセス制御ポリシーをプログラムで管理する方法について詳しくは、[Access Control API](../../access-control/abac/api/policies.md) の `/policies` エンドポイントガイドを参照してください。
