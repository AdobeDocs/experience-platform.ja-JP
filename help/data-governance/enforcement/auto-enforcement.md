...
有料メディアのアクティベーションなど、ストリーミング宛先に対する同意ポリシーの適用が強化されました。 この強化は、Privacy and Security Shield または Healthcare Shield のお客様が利用できるもので、同意ステータスの変更に応じて、プロファイルがストリーミング宛先からプロアクティブに削除されます。 また、適切なオーディエンスが常にターゲットになるように、同意の変更が即座に反映されます。
