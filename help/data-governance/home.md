...
Adobe Experience Platform データガバナンスを使用すると、顧客データを管理し、データの使用に適した規制、制限、ポリシーへのコンプライアンスを確保できます。[!DNL Experience Platform] 内の様々なレベルで重要な役割を果たします（例えば、カタログ化、データ系列、データ使用ラベル、データ使用ポリシー、マーケティングアクションのデータの使用制御など）。
...
データガバナンスフレームワークは、データの分類とデータ使用ポリシーの作成のプロセスを簡素化および合理化します。 データラベルが適用され、データ使用ポリシーが設定されたら、マーケティングアクションを評価して、データが正しく使用されていることを確認できます。

データガバナンスフレームワークには、次の 3 つの主要な要素があります。ラベル、ポリシーおよび実施。
...
次の表に、データガバナンスとデータガバナンスフレームワークに関連する主な用語の概要を示します。
...
次のビデオは、お客様がデータガバナンスフレームワークを理解できるようにすることを目的としています。

>[!VIDEO](https://video.tv.adobe.com/v/29708?quality=12&enable10seconds=on&speedcontrol=on)

次のビデオでは、Experience Platformの様々なデータガバナンス機能の概要を説明します。
