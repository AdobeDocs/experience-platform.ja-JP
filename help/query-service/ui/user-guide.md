...
>[!NOTE]
>
>従来のエディターは、2024 年 5 月 30 日（PT）に非推奨（廃止予定）となりました。 使用するためにアクセスできなくなりました。 これで、を使用できます [クエリエディターの強化](#enhanced-editor-toggle) クエリを記述、検証、実行するには
...
>[!NOTE]
>
>従来のエディターは、2024 年 5 月 30 日（PT）に非推奨（廃止予定）となりました。 使用するためにアクセスできなくなりました。 拡張クエリエディターを使用して、クエリの書き込み、検証、実行ができるようになりました。
