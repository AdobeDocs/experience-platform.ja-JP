...
# Query accelerated Store レポートインサイトガイド
...
![新しいレポートインサイトデータモデルから作成された、宛先およびオーディエンス別の一致数。](../../images/data-distiller/customizable-insights/user-defined-dashboard-widget.png)
