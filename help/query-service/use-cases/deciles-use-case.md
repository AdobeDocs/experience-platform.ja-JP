...
[&#128279;](../../xdm/tutorials/create-schema-ui.md) スキーマレジストリ API または [&#x200B; スキーマエディターのユーザーインターフェイス &#x200B;](../../xdm/tutorials/create-schema-api.md) を使用して、リアルタイム顧客プロファイルで使用するスキーマを有効にします 。  プロファイルのスキーマを有効にする方法について詳しくは、それぞれのドキュメントを参照してください。
