...
## バージョン 1.6.5 - 2026年3月24日（PT）

* アクティブなAssurance セッションでAppMeasurementからのイベントが送信されない問題を修正しました。

## バージョン 1.6.4 - 2025年5月6日（PT）

* ログインが利用できない問題を修正しました。

## バージョン 1.6.3 - 2025年4月30日（PT）

* デバッガーがDTMおよびタグ関数を機能させない問題を修正しました。
* Analyticsの後処理ヒットがログに表示されない問題を修正しました。
* 日本語などの非ASCII言語のデータがログに正しく表示されない問題を修正しました。

## バージョン 1.6.2 - 2024年10月1日（PT）

* デバッガーがすべてのCSP エラーに対して過敏であった問題を修正しました
